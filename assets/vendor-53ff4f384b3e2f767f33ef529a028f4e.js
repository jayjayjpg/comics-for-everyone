window.EmberENV={FEATURES:{},EXTEND_PROTOTYPES:{Date:!1},_APPLICATION_TEMPLATE_WRAPPER:!1,_JQUERY_INTEGRATION:!0}
...
return!!t&&(t===g||"GeneratorFunction"===(t.displayName||t.name))},s.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,y):(e.__proto__=y,o in e||(e[o]="GeneratorFunction")),e.prototype=Object.create(f),e},s.awrap=function(e){return new _(e)},b(E.prototype),s.async=function(e,t,n,r){var i=new E(p(e,t,n,r))
...
if(r in e)return n.value=r,n.done=!1,n}return n.done=!0,n}},s.values=S,A.prototype={constructor:A,reset:function(e){if(this.prev=0,this.next=0,this.sent=this._sent=t,this.done=!1,this.delegate=null,this.tryEntries.forEach(R),!e)for(var r in this)"t"===r.charAt(0)&&n.call(this,r)&&!isNaN(+r.slice(1))&&(this[r]=t)},stop:function(){this.done=!0
...
R(n)}return i}}throw new Error("illegal catch attempt")},delegateYield:function(e,t,n){return this.delegate={iterator:S(e),resultName:t,nextLoc:n},d}}}function p(e,n,r,i){var o=n&&n.prototype instanceof v?n:v,a=Object.create(o.prototype),s=new A(i||[])
...
t.type="normal",delete t.arg,e.completion=t}function A(e){this.tryEntries=[{tryLoc:"root"}],e.forEach(w,this),this.reset(!0)}function S(e){if(e){var r=e[i]
...
var R=function(e){var t,n,r,i,o,a,s,u,l,c,h,d,f,p,m,v,g,y,b,_="sizzle"+1*new Date,E=e.document,w=0,R=0,A=ue(),S=ue(),k=ue(),x=ue(),T=function(e,t){return e===t&&(h=!0),0},C={}.hasOwnProperty,O=[],M=O.pop,P=O.push,D=O.push,N=O.slice,L=function(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n]===t)return n
return-1},j="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",I="[\\x20\\t\\r\\n\\f]",F="(?:\\\\.|[\\w-]|[^\0-\\xa0])+",z="\\["+I+"*("+F+")(?:"+I+"*([*^$|!~]?=)"+I+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+F+"))|)"+I+"*\\]",B=":("+F+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+z+")*)|.*)\\)|)",q=new RegExp(I+"+","g"),U=new RegExp("^"+I+"+|((?:^|[^\\\\])(?:\\\\.)*)"+I+"+$","g"),H=new RegExp("^"+I+"*,"+I+"*"),V=new RegExp("^"+I+"*([>+~]|"+I+")"+I+"*"),W=new RegExp(I+"|>"),Y=new RegExp(B),K=new RegExp("^"+F+"$"),G={ID:new RegExp("^#("+F+")"),CLASS:new RegExp("^\\.("+F+")"),TAG:new RegExp("^("+F+"|[*])"),ATTR:new RegExp("^"+z),PSEUDO:new RegExp("^"+B),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+I+"*(even|odd|(([+-]|)(\\d*)n|)"+I+"*(?:([+-]|)"+I+"*(\\d+)|))"+I+"*\\)|)","i"),bool:new RegExp("^(?:"+j+")$","i"),needsContext:new RegExp("^"+I+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+I+"*((?:-\\d)?\\d*)"+I+"*\\)|)(?=[^-]|$)","i")},$=/HTML$/i,Q=/^(?:input|select|textarea|button)$/i,X=/^h\d$/i,J=/^[^{]+\{\s*\[native \w/,Z=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,ee=/[+~]/,te=new RegExp("\\\\([\\da-f]{1,6}"+I+"?|("+I+")|.)","ig"),ne=function(e,t,n){var r="0x"+t-65536
return r!=r||n?t:r<0?String.fromCharCode(r+65536):String.fromCharCode(r>>10|55296,1023&r|56320)},re=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,ie=function(e,t){return t?"\0"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e},oe=function(){d()},ae=_e(function(e){return!0===e.disabled&&"fieldset"===e.nodeName.toLowerCase()},{dir:"parentNode",next:"legend"})
try{D.apply(O=N.call(E.childNodes),E.childNodes),O[E.childNodes.length].nodeType}catch(Se){D={apply:O.length?function(e,t){P.apply(e,N.call(t))}:function(e,t){for(var n=e.length,r=0;e[n++]=t[r++];);e.length=n-1}}}function se(e,t,r,i){var o,s,l,c,h,p,g,y=t&&t.ownerDocument,w=t?t.nodeType:9
if(r=r||[],"string"!=typeof e||!e||1!==w&&9!==w&&11!==w)return r
if(!i&&((t?t.ownerDocument||t:E)!==f&&d(t),t=t||f,m)){if(11!==w&&(h=Z.exec(e)))if(o=h[1]){if(9===w){if(!(l=t.getElementById(o)))return r
...
if((o=h[3])&&n.getElementsByClassName&&t.getElementsByClassName)return D.apply(r,t.getElementsByClassName(o)),r}if(n.qsa&&!x[e+" "]&&(!v||!v.test(e))&&(1!==w||"object"!==t.nodeName.toLowerCase())){if(g=e,y=t,1===w&&W.test(e)){for((c=t.getAttribute("id"))?c=c.replace(re,ie):t.setAttribute("id",c=_),s=(p=a(e)).length;s--;)p[s]="#"+c+" "+be(p[s])
g=p.join(","),y=ee.test(e)&&ge(t.parentNode)||t}try{return D.apply(r,y.querySelectorAll(g)),r}catch(R){x(e,!0)}finally{c===_&&t.removeAttribute("id")}}}return u(e.replace(U,"$1"),t,r,i)}function ue(){var e=[]
...
try{return!!e(t)}catch(Se){return!1}finally{t.parentNode&&t.parentNode.removeChild(t),t=null}}function he(e,t){for(var n=e.split("|"),i=n.length;i--;)r.attrHandle[n[i]]=t}function de(e,t){var n=t&&e,r=n&&1===e.nodeType&&1===t.nodeType&&e.sourceIndex-t.sourceIndex
if(r)return r
...
return!$.test(t||n&&n.nodeName||"HTML")},d=se.setDocument=function(e){var t,i,a=e?e.ownerDocument||e:E
...
return r||(1&(r=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1)||!n.sortDetached&&t.compareDocumentPosition(e)===r?e===f||e.ownerDocument===E&&b(E,e)?-1:t===f||t.ownerDocument===E&&b(E,t)?1:c?L(c,e)-L(c,t):0:4&r?-1:1)}:function(e,t){if(e===t)return h=!0,0
...
for(;a[r]===s[r];)r++
return r?de(a[r],s[r]):a[r]===E?-1:s[r]===E?1:0},f):f},se.matches=function(e,t){return se(e,null,null,t)},se.matchesSelector=function(e,t){if((e.ownerDocument||e)!==f&&d(e),n.matchesSelector&&m&&!x[t+" "]&&(!g||!g.test(t))&&(!v||!v.test(t)))try{var r=y.call(e,t)
if(r||n.disconnectedMatch||e.document&&11!==e.document.nodeType)return r}catch(Se){x(t,!0)}return se(t,f,null,[e]).length>0},se.contains=function(e,t){return(e.ownerDocument||e)!==f&&d(e),b(e,t)},se.attr=function(e,t){(e.ownerDocument||e)!==f&&d(e)
...
return G.CHILD.test(e[0])?null:(e[3]?e[2]=e[4]||e[5]||"":n&&Y.test(n)&&(t=a(n,!0))&&(t=n.indexOf(")",n.length-t)-n.length)&&(e[0]=e[0].slice(0,t),e[2]=n.slice(0,t)),e.slice(0,3))}},filter:{TAG:function(e){var t=e.replace(te,ne).toLowerCase()
return"*"===e?function(){return!0}:function(e){return e.nodeName&&e.nodeName.toLowerCase()===t}},CLASS:function(e){var t=A[e+" "]
return t||(t=new RegExp("(^|"+I+")"+e+"("+I+"|$)"))&&A(e,function(e){return t.test("string"==typeof e.className&&e.className||void 0!==e.getAttribute&&e.getAttribute("class")||"")})},ATTR:function(e,t,n){return function(r){var i=se.attr(r,e)
...
p=m="only"===e&&!p&&"nextSibling"}return!0}if(p=[a?v.firstChild:v.lastChild],a&&y){for(b=(f=(l=(c=(h=(d=v)[_]||(d[_]={}))[d.uniqueID]||(h[d.uniqueID]={}))[e]||[])[0]===w&&l[1])&&l[2],d=f&&v.childNodes[f];d=++f&&d&&d[m]||(b=f=0)||p.pop();)if(1===d.nodeType&&++b&&d===t){c[e]=[w,f,b]
break}}else if(y&&(b=f=(l=(c=(h=(d=t)[_]||(d[_]={}))[d.uniqueID]||(h[d.uniqueID]={}))[e]||[])[0]===w&&l[1]),!1===b)for(;(d=++f&&d&&d[m]||(b=f=0)||p.pop())&&((s?d.nodeName.toLowerCase()!==g:1!==d.nodeType)||!++b||(y&&((c=(h=d[_]||(d[_]={}))[d.uniqueID]||(h[d.uniqueID]={}))[e]=[w,b]),d!==t)););return(b-=i)===r||b%r==0&&b/r>=0}}},PSEUDO:function(e,t){var n,i=r.pseudos[e]||r.setFilters[e.toLowerCase()]||se.error("unsupported pseudo: "+e)
...
return r[_]?le(function(e,t,n,i){for(var o,a=r(e,null,i,[]),s=e.length;s--;)(o=a[s])&&(e[s]=!(t[s]=o))}):function(e,i,o){return t[0]=e,r(t,null,o,n),t[0]=null,!n.pop()}}),has:le(function(e){return function(t){return se(e,t).length>0}}),contains:le(function(e){return e=e.replace(te,ne),function(t){return(t.textContent||i(t)).indexOf(e)>-1}}),lang:le(function(e){return K.test(e||"")||se.error("unsupported lang: "+e),e=e.replace(te,ne).toLowerCase(),function(t){var n
...
return!1}:function(t,n,u){var l,c,h,d=[w,s]
...
else{if((l=c[o])&&l[0]===w&&l[1]===s)return d[2]=l[2]
...
return n}(t||"*",s.nodeType?[s]:s,[]),v=!e||!o&&t?m:we(m,d,e,s,u),g=n?i||(o?e:p||r)?[]:a:v
if(n&&n(v,g,s,u),r)for(l=we(g,f),r(l,[],s,u),c=l.length;c--;)(h=l[c])&&(g[f[c]]=!(v[f[c]]=h))
if(o){if(i||e){if(i){for(l=[],c=g.length;c--;)(h=g[c])&&l.push(v[c]=h)
i(null,g=[],l,u)}for(c=g.length;c--;)(h=g[c])&&(l=i?L(o,h):d[c])>-1&&(o[l]=!(a[l]=h))}}else g=we(g===a?g.splice(p,g.length):g),i?i(null,a,g,u):D.apply(a,g)})}function Ae(e){for(var t,n,i,o=e.length,a=r.relative[e[0].type],s=a||r.relative[" "],u=a?1:0,c=_e(function(e){return e===t},s,!0),h=_e(function(e){return L(t,e)>-1},s,!0),d=[function(e,n,r){var i=!a&&(r||n!==l)||((t=n).nodeType?c(e,n,r):h(e,n,r))
return t=null,i}];u<o;u++)if(n=r.relative[e[u].type])d=[_e(Ee(d),n)]
else{if((n=r.filter[e[u].type].apply(null,e[u].matches))[_]){for(i=++u;i<o&&!r.relative[e[i].type];i++);return Re(u>1&&Ee(d),u>1&&be(e.slice(0,u-1).concat({value:" "===e[u-2].type?"*":""})).replace(U,"$1"),n,u<i&&Ae(e.slice(u,i)),i<o&&Ae(e=e.slice(i)),i<o&&be(e))}d.push(n)}return Ee(d)}return ye.prototype=r.filters=r.pseudos,r.setFilters=new ye,a=se.tokenize=function(e,t){var n,i,o,a,s,u,l,c=S[e+" "]
if(c)return t?0:c.slice(0)
for(s=e,u=[],l=r.preFilter;s;){for(a in n&&!(i=H.exec(s))||(i&&(s=s.slice(i[0].length)||s),u.push(o=[])),n=!1,(i=V.exec(s))&&(n=i.shift(),o.push({value:n,type:i[0].replace(U," ")}),s=s.slice(n.length)),r.filter)!(i=G[a].exec(s))||l[a]&&!(i=l[a](i))||(n=i.shift(),o.push({value:n,type:a,matches:i}),s=s.slice(n.length))
if(!n)break}return t?s.length:s?se.error(e):S(e,u).slice(0)},s=se.compile=function(e,t){var n,i=[],o=[],s=k[e+" "]
if(!s){for(t||(t=a(e)),n=t.length;n--;)(s=Ae(t[n]))[_]?i.push(s):o.push(s);(s=k(e,function(e,t){var n=t.length>0,i=e.length>0,o=function(o,a,s,u,c){var h,p,v,g=0,y="0",b=o&&[],_=[],E=l,R=o||i&&r.find.TAG("*",c),A=w+=null==E?1:Math.random()||.1,S=R.length
for(c&&(l=a===f||a||c);y!==S&&null!=(h=R[y]);y++){if(i&&h){for(p=0,a||h.ownerDocument===f||(d(h),s=!m);v=e[p++];)if(v(h,a||f,s)){u.push(h)
break}c&&(w=A)}n&&((h=!v&&h)&&g--,o&&b.push(h))}if(g+=y,n&&y!==g){for(p=0;v=t[p++];)v(b,_,a,s)
if(o){if(g>0)for(;y--;)b[y]||_[y]||(_[y]=M.call(u))
_=we(_)}D.apply(u,_),c&&!o&&_.length>0&&g+t.length>1&&se.uniqueSort(u)}return c&&(w=A,l=E),b}
...
d&&(t=t.parentNode),e=e.slice(u.shift().value.length)}for(o=G.needsContext.test(e)?0:u.length;o--&&(l=u[o],!r.relative[c=l.type]);)if((h=r.find[c])&&(i=h(l.matches[0].replace(te,ne),ee.test(u[0].type)&&ge(t.parentNode)||t))){if(u.splice(o,1),!(e=i.length&&be(u)))return D.apply(n,i),n
break}}return(d||s(e,f))(i,t,!m,n,!t||ee.test(e)&&ge(t.parentNode)||t),n},n.sortStable=_.split("").sort(T).join("")===_,n.detectDuplicates=!!h,d(),n.sortDetached=ce(function(e){return 1&e.compareDocumentPosition(f.createElement("fieldset"))}),ce(function(e){return e.innerHTML="<a href='#'></a>","#"===e.firstChild.getAttribute("href")})||he("type|href|height|width",function(e,t,n){if(!n)return e.getAttribute(t,"type"===t.toLowerCase()?1:2)}),n.attributes&&ce(function(e){return e.innerHTML="<input/>",e.firstChild.setAttribute("value",""),""===e.firstChild.getAttribute("value")})||he("value",function(e,t,n){if(!n&&"input"===e.nodeName.toLowerCase())return e.defaultValue}),ce(function(e){return null==e.getAttribute("disabled")})||he(j,function(e,t,n){var r
...
function x(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()}var T=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i
...
var L=/[^\x20\t\r\n\f]+/g
function j(e){return e}function I(e){throw e}function F(e,t,n,r){var i
...
l=e&&("object"==typeof e||"function"==typeof e)&&e.then,m(l)?i?l.call(e,a(o,n,j,i),a(o,n,I,i)):(o++,l.call(e,a(o,n,j,i),a(o,n,I,i),a(o,n,j,n.notifyWith))):(r!==j&&(s=void 0,u=[e]),(i||n.resolveWith)(s,u))}},c=i?l:function(){try{l()}catch(e){_.Deferred.exceptionHook&&_.Deferred.exceptionHook(e,c.stackTrace),t+1>=o&&(r!==I&&(s=void 0,u=[e]),n.rejectWith(s,u))}}
t?c():(_.Deferred.getStackHook&&(c.stackTrace=_.Deferred.getStackHook()),e.setTimeout(c))}}return _.Deferred(function(e){n[0][3].add(a(0,e,m(i)?i:j,e.notifyWith)),n[1][3].add(a(0,e,m(t)?t:j)),n[2][3].add(a(0,e,m(r)?r:I))}).promise()},promise:function(e){return null!=e?_.extend(e,i):i}},o={}
...
function W(e,t){return t.toUpperCase()}function Y(e){return e.replace(H,"ms-").replace(V,W)}var K=function(e){return 1===e.nodeType||9===e.nodeType||!+e.nodeType}
...
var ye,be,_e=/<|&#?\w+;/
function Ee(e,t,n,r,i){for(var o,a,s,u,l,c,h=t.createDocumentFragment(),d=[],f=0,p=e.length;f<p;f++)if((o=e[f])||0===o)if("object"===b(o))_.merge(d,o.nodeType?[o]:o)
...
function Se(){return!0}function ke(){return!1}function xe(e,t){return e===function(){try{return r.activeElement}catch(e){}}()==("focus"===t)}function Te(e,t,n,r,i,o){var a,s
...
return de.test(t.type)&&t.click&&x(t,"input")&&Ce(t,"click",Se),!1},trigger:function(e){var t=this||e
return de.test(t.type)&&t.click&&x(t,"input")&&Ce(t,"click"),!0},_default:function(e){var t=e.target
return de.test(t.type)&&t.click&&x(t,"input")&&$.get(t,"click")||x(t,"a")}},beforeunload:{postDispatch:function(e){void 0!==e.result&&e.originalEvent&&(e.originalEvent.returnValue=e.result)}}}},_.removeEvent=function(e,t,n){e.removeEventListener&&e.removeEventListener(t,n)},_.Event=function(e,t){if(!(this instanceof _.Event))return new _.Event(e,t)
...
return null==e.which&&we.test(e.type)?null!=e.charCode?e.charCode:e.keyCode:!e.which&&void 0!==t&&Re.test(e.type)?1&t?1:2&t?3:4&t?2:0:e.which}},_.event.addProp),_.each({focus:"focusin",blur:"focusout"},function(e,t){_.event.special[e]={setup:function(){return Ce(this,e,xe),!1},trigger:function(){return Ce(this,e),!0},delegateType:t}}),_.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(e,t){_.event.special[e]={delegateType:t,bindType:t,handle:function(e){var n,r=e.relatedTarget,i=e.handleObj
...
function Ne(e,t){return x(e,"table")&&x(11!==t.nodeType?t:t.firstChild,"tr")&&_(e).children("tbody")[0]||e}function Le(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function je(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function Ie(e,t){var n,r,i,o,a,s,u,l
...
if(g||d>1&&"string"==typeof v&&!p.checkClone&&Pe.test(v))return e.each(function(i){var o=e.eq(i)
g&&(t[0]=v.call(this,i,o.html())),Fe(o,t,n,r)})
if(d&&(o=(i=Ee(t,e[0].ownerDocument,!1,e,r)).firstChild,1===i.childNodes.length&&(i=o),o||r)){for(u=(s=_.map(ve(i,"script"),Le)).length;h<d;h++)l=i,h!==f&&(l=_.clone(l,!0,!0),u&&_.merge(s,ve(l,"script"))),n.call(e[h],l,h)
if(u)for(c=s[s.length-1].ownerDocument,_.map(s,je),h=0;h<u;h++)l=s[h],pe.test(l.type||"")&&!$.access(l,"globalEval")&&_.contains(c,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?_._evalUrl&&!l.noModule&&_._evalUrl(l.src,{nonce:l.nonce||l.getAttribute("nonce")}):y(l.textContent.replace(De,""),l,c))}return e}function ze(e,t,n){for(var r,i=t?_.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||_.cleanData(ve(r)),r.parentNode&&(n&&ie(r)&&ge(ve(r,"script")),r.parentNode.removeChild(r))
...
return(a=ve(c,"script")).length>0&&ge(a,!h&&ve(e,"script")),c},cleanData:function(e){for(var t,n,r,i=_.event.special,o=0;void 0!==(n=e[o]);o++)if(K(n)){if(t=n[$.expando]){if(t.events)for(r in t.events)i[r]?_.event.remove(n,r):_.removeEvent(n,r,t.handle)
...
var Be=new RegExp("^("+ee+")(?!px)[a-z%]+$","i"),qe=function(t){var n=t.ownerDocument.defaultView
return n&&n.opener||(n=e),n.getComputedStyle(t)},Ue=new RegExp(ne.join("|"),"i")
function He(e,t,n){var r,i,o,a,s=e.style
return(n=n||qe(e))&&(""!==(a=n.getPropertyValue(t)||n[t])||ie(e)||(a=_.style(e,t)),!p.pixelBoxStyles()&&Be.test(a)&&Ue.test(t)&&(r=s.width,i=s.minWidth,o=s.maxWidth,s.minWidth=s.maxWidth=s.width=a,a=n.width,s.width=r,s.minWidth=i,s.maxWidth=o)),void 0!==a?a+"":a}function Ve(e,t){return{get:function(){if(!e())return(this.get=t).apply(this,arguments)
...
var We=["Webkit","Moz","ms"],Ye=r.createElement("div").style,Ke={}
function Ge(e){var t=_.cssProps[e]||Ke[e]
return t||(e in Ye?e:Ke[e]=function(e){for(var t=e[0].toUpperCase()+e.slice(1),n=We.length;n--;)if((e=We[n]+t)in Ye)return e}(e)||e)}var $e=/^(none|table(?!-c[ea]).+)/,Qe=/^--/,Xe={position:"absolute",visibility:"hidden",display:"block"},Je={letterSpacing:"0",fontWeight:"400"}
...
return!r&&o>=0&&(u+=Math.max(0,Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-o-u-s-.5))||0),u}function tt(e,t,n){var r=qe(e),i=(!p.boxSizingReliable()||n)&&"border-box"===_.css(e,"boxSizing",!1,r),o=i,a=He(e,t,r),s="offset"+t[0].toUpperCase()+t.slice(1)
...
return i}},"margin"!==e&&(_.cssHooks[e+t].set=Ze)}),_.fn.extend({css:function(e,t){return U(this,function(e,t,n){var r,i,o={},a=0
...
function vt(e){return(e.match(L)||[]).join(" ")}function gt(e){return e.getAttribute&&e.getAttribute("class")||""}function yt(e){return Array.isArray(e)?e:"string"==typeof e&&e.match(L)||[]}_.fn.extend({prop:function(e,t){return U(this,_.prop,e,t,arguments.length>1)},removeProp:function(e){return this.each(function(){delete this[_.propFix[e]||e]})}}),_.extend({prop:function(e,t,n){var r,i,o=e.nodeType
...
u===(i.ownerDocument||r)&&g.push(u.defaultView||u.parentWindow||e)}for(a=0;(s=g[a++])&&!t.isPropagationStopped();)p=s,t.type=a>1?l:f.bindType||y,(d=($.get(s,"events")||{})[t.type]&&$.get(s,"handle"))&&d.apply(s,n),(d=c&&s[c])&&d.apply&&K(s)&&(t.result=d.apply(s,n),!1===t.result&&t.preventDefault())
return t.type=y,o||t.isDefaultPrevented()||f._default&&!1!==f._default.apply(g.pop(),n)||!K(i)||c&&m(i[y])&&!v(i)&&((u=i[c])&&(i[c]=null),_.event.triggered=y,t.isPropagationStopped()&&p.addEventListener(y,Et),i[y](),t.isPropagationStopped()&&p.removeEventListener(y,Et),_.event.triggered=void 0,u&&(i[c]=u)),t.result}},simulate:function(e,t,n){var r=_.extend(new _.Event,n,{type:e,isSimulated:!0})
...
if(Array.isArray(t))_.each(t,function(t,i){n||St.test(e)?r(e,i):Ct(e+"["+("object"==typeof i&&null!=i?t:"")+"]",i,n,r)})
...
return this.name&&!_(this).is(":disabled")&&Tt.test(this.nodeName)&&!xt.test(e)&&(this.checked||!de.test(e))}).map(function(e,t){var n=_(this).val()
return null==n?null:Array.isArray(n)?_.map(n,function(e){return{name:t.name,value:e.replace(kt,"\r\n")}}):{name:t.name,value:n.replace(kt,"\r\n")}}).get()}})
var Ot=/%20/g,Mt=/#.*$/,Pt=/([?&])_=[^&]*/,Dt=/^(.*?):[ \t]*([^\r\n]*)$/gm,Nt=/^(?:GET|HEAD)$/,Lt=/^\/\//,jt={},It={},Ft="*/".concat("*"),zt=r.createElement("a")
function Bt(e){return function(t,n){"string"!=typeof t&&(n=t,t="*")
var r,i=0,o=t.toLowerCase().match(L)||[]
if(m(n))for(;r=o[i++];)"+"===r[0]?(r=r.slice(1)||"*",(e[r]=e[r]||[]).unshift(n)):(e[r]=e[r]||[]).push(n)}}function qt(e,t,n,r){var i={},o=e===It
function a(s){var u
...
return r&&_.extend(!0,e,r),e}zt.href=wt.href,_.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:wt.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(wt.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Ft,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":_.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(e,t){return t?Ut(Ut(e,_.ajaxSettings),t):Ut(_.ajaxSettings,e)},ajaxPrefilter:Bt(jt),ajaxTransport:Bt(It),ajax:function(t,n){"object"==typeof t&&(n=t,t=void 0),n=n||{}
var i,o,a,s,u,l,c,h,d,f,p=_.ajaxSetup({},n),m=p.context||p,v=p.context&&(m.nodeType||m.jquery)?_(m):_.event,g=_.Deferred(),y=_.Callbacks("once memory"),b=p.statusCode||{},E={},w={},R="canceled",A={readyState:0,getResponseHeader:function(e){var t
...
if(g.promise(A),p.url=((t||p.url||wt.href)+"").replace(Lt,wt.protocol+"//"),p.type=n.method||n.type||p.method||p.type,p.dataTypes=(p.dataType||"*").toLowerCase().match(L)||[""],null==p.crossDomain){l=r.createElement("a")
try{l.href=p.url,l.href=l.href,p.crossDomain=zt.protocol+"//"+zt.host!=l.protocol+"//"+l.host}catch(k){p.crossDomain=!0}}if(p.data&&p.processData&&"string"!=typeof p.data&&(p.data=_.param(p.data,p.traditional)),qt(jt,p,n,A),c)return A
for(d in(h=_.event&&p.global)&&0==_.active++&&_.event.trigger("ajaxStart"),p.type=p.type.toUpperCase(),p.hasContent=!Nt.test(p.type),o=p.url.replace(Mt,""),p.hasContent?p.data&&p.processData&&0===(p.contentType||"").indexOf("application/x-www-form-urlencoded")&&(p.data=p.data.replace(Ot,"+")):(f=p.url.slice(o.length),p.data&&(p.processData||"string"==typeof p.data)&&(o+=(At.test(o)?"&":"?")+p.data,delete p.data),!1===p.cache&&(o=o.replace(Pt,"$1"),f=(At.test(o)?"&":"?")+"_="+Rt+++f),p.url=o+f),p.ifModified&&(_.lastModified[o]&&A.setRequestHeader("If-Modified-Since",_.lastModified[o]),_.etag[o]&&A.setRequestHeader("If-None-Match",_.etag[o])),(p.data&&p.hasContent&&!1!==p.contentType||n.contentType)&&A.setRequestHeader("Content-Type",p.contentType),A.setRequestHeader("Accept",p.dataTypes[0]&&p.accepts[p.dataTypes[0]]?p.accepts[p.dataTypes[0]]+("*"!==p.dataTypes[0]?", "+Ft+"; q=0.01":""):p.accepts["*"]),p.headers)A.setRequestHeader(d,p.headers[d])
if(p.beforeSend&&(!1===p.beforeSend.call(m,A,p)||c))return A.abort()
if(R="abort",y.add(p.complete),A.done(p.success),A.fail(p.error),i=qt(It,p,n,A)){if(A.readyState=1,h&&v.trigger("ajaxSend",[A,p]),c)return A
p.async&&p.timeout>0&&(u=e.setTimeout(function(){A.abort("timeout")},p.timeout))
try{c=!1,i.send(E,S)}catch(k){if(c)throw k
S(-1,k)}}else S(-1,"No Transport")
function S(t,n,r,s){var l,d,f,E,w,R=n
...
return this[e]=!0,e}}),_.ajaxPrefilter("json jsonp",function(t,n,r){var i,o,a,s=!1!==t.jsonp&&(Kt.test(t.url)?"url":"string"==typeof t.data&&0===(t.contentType||"").indexOf("application/x-www-form-urlencoded")&&Kt.test(t.data)&&"data")
if(s||"jsonp"===t.dataTypes[0])return i=t.jsonpCallback=m(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,s?t[s]=t[s].replace(Kt,"$1"+i):!1!==t.jsonp&&(t.url+=(At.test(t.url)?"&":"?")+t.jsonp+"="+i),t.converters["script json"]=function(){return a||_.error(i+" was not called"),a[0]},t.dataTypes[0]="json",o=e[i],e[i]=function(){a=arguments},r.always(function(){void 0===o?_(e).removeProp(i):e[i]=o,t[i]&&(t.jsonpCallback=n.jsonpCallback,Yt.push(i)),a&&m(o)&&o(a[0]),a=o=void 0}),"script"}),p.createHTMLDocument=((Wt=r.implementation.createHTMLDocument("").body).innerHTML="<form></form><form></form>",2===Wt.childNodes.length),_.parseHTML=function(e,t,n){return"string"!=typeof e?[]:("boolean"==typeof t&&(n=t,t=!1),t||(p.createHTMLDocument?((i=(t=r.implementation.createHTMLDocument("")).createElement("base")).href=r.location.href,t.head.appendChild(i)):t=r),a=!n&&[],(o=T.exec(e))?[t.createElement(o[1])]:(o=Ee([e],t,a),a&&a.length&&_(a).remove(),_.merge([],o.childNodes)))
...
var Gt=e.jQuery,$t=e.$
return _.noConflict=function(t){return e.$===_&&(e.$=$t),t&&e.jQuery===_&&(e.jQuery=Gt),_},t||(e.jQuery=e.$=_),_}),function(){var e,t,n
...
e.default=a}),e("@ember/-internals/glimmer",["exports","node-module","ember-babel","@ember/polyfills","@ember/-internals/owner","@glimmer/opcode-compiler","@ember/-internals/runtime","@ember/-internals/utils","@glimmer/reference","@ember/-internals/metal","@ember/debug","@glimmer/runtime","@glimmer/util","@ember/-internals/views","@ember/-internals/browser-environment","@ember/instrumentation","@ember/service","@ember/-internals/environment","@ember/string","@glimmer/wire-format","@ember/-internals/container","@ember/runloop","rsvp","@glimmer/node","@ember/-internals/routing","@ember/deprecated-features"],function(e,t,n,r,i,o,a,s,u,l,c,h,d,f,p,m,v,g,y,b,_,E,w,R,A,S){"use strict"
function k(){const e=L(["component:-default"])
return k=function(){return e},e}function x(){const e=L(["template-compiler:main"])
return x=function(){return e},e}function T(){const e=L(["template-compiler:main"])
return T=function(){return e},e}function C(){const e=L(["template:components/-default"])
return C=function(){return e},e}function O(){const e=L(["template:-root"])
return O=function(){return e},e}function M(){const e=L(["template:-root"])
return M=function(){return e},e}function P(){const e=L(["component:-default"])
return P=function(){return e},e}function D(){const e=L(["template:components/-default"])
return D=function(){return e},e}function N(){const e=L(["template:components/-default"])
return N=function(){return e},e}function L(e,t){return t||(t=e.slice(0)),e.raw=t,e}var j
function I(e){return new F((0,o.templateFactory)(e))}e.template=I,e.helper=H,e.escapeExpression=function(e){if("string"!=typeof e){if(e&&e.toHTML)return e.toHTML()
if(null==e)return""
if(!e)return String(e)
e=String(e)}if(!rt.test(e))return e
return e.replace(it,ot)},e.htmlSafe=at,e.isHTMLSafe=st,e._resetRenderers=function(){Wt.length=0},e.renderSettled=function(){null===Gt&&(Gt=w.default.defer(),(0,E.getCurrentRunLoop)()||E.backburner.schedule("actions",null,Kt))
return Gt.promise},e.getTemplate=function(e){if(Zt.hasOwnProperty(e))return Zt[e]},e.setTemplate=function(e,t){return Zt[e]=t},e.hasTemplate=function(e){return Zt.hasOwnProperty(e)},e.getTemplates=function(){return Zt},e.setTemplates=function(e){Zt=e},e.setupEngineRegistry=function(e){e.register("view:-outlet",_r),e.register("template:-outlet",gr),e.injection("view:-outlet","template","template:-outlet"),e.injection("service:-dom-changes","document","service:-document"),e.injection("service:-dom-tree-construction","document","service:-document"),e.register((0,_.privatize)(C()),mr),e.register("service:-glimmer-environment",ct),e.register((0,_.privatize)(T()),pr),e.injection("template","compiler",(0,_.privatize)(x())),e.optionsForType("helper",{instantiate:!1}),e.register("helper:loc",dn),e.register("component:-text-field",we),e.register("component:-checkbox",_e),e.register("component:link-to",Ce),e.register("component:input",hn),e.register("template:components/input",vr),e.register("component:textarea",Re)
...
return this.factory.create(e.compiler,{owner:t})},e}(),z=I({id:"T+MWx6cw",block:'{"symbols":[],"statements":[[1,[29,"component",[[24,0,[]]],null],false]],"hasEval":false}',meta:{moduleName:"packages/@ember/-internals/glimmer/lib/templates/root.hbs"}})
e.RootTemplate=z
var B=(0,s.symbol)("RECOMPUTE_TAG")
var q=a.FrameworkObject.extend({init:function(){this._super.apply(this,arguments),this[B]=u.DirtyableTag.create()},recompute:function(){this[B].inner.dirty()}})
...
function H(e){return new U(e)}function V(e){return(0,a.isArray)(e)?0!==e.length:Boolean(e)}var W=(0,s.symbol)("UPDATE"),Y=(0,s.symbol)("INVOKE")
e.INVOKE=Y
var K=(0,s.symbol)("ACTION"),G=function(){function e(){}return e.prototype.get=function(e){return X.create(this,e)},e}(),$=function(e){function t(){var t
...
return null!==t&&e.validate(t)||(n=this.lastValue=this.compute(),this.lastRevision=e.value()),n},t}(G),Q=function(e){function t(t){var n
...
throw(0,d.unreachable)()}(e.value(),t):new Z(e,t)},t.prototype.get=function(e){return new Z(this,e)},t}($),J=function(e){function t(t,n){var r
...
return ue(e)?t?new Q(e):new oe(e):le(e)?new oe(e):h.PrimitiveReference.create(e)}var de=(0,s.symbol)("DIRTY_TAG"),fe=(0,s.symbol)("ARGS"),pe=(0,s.symbol)("ROOT_REF")
e.ROOT_REF=pe
var me=(0,s.symbol)("IS_DISPATCHING_ATTRS"),ve=(0,s.symbol)("HAS_BLOCK"),ge=(0,s.symbol)("BOUNDS"),ye=f.CoreView.extend(f.ChildViewsSupport,f.ViewStateSupport,f.ClassNamesSupport,a.TargetActionSupport,f.ActionSupport,f.ViewMixin,((j={isComponent:!0,init:function(){this._super.apply(this,arguments),this[me]=!1,this[de]=u.DirtyableTag.create(),this[pe]=new Q(this),this[ge]=null},rerender:function(){this[de].inner.dirty(),this._super()}})[l.PROPERTY_DID_CHANGE]=function(e){if(!this[me]){var t=this[fe],n=void 0!==t?t[e]:void 0
void 0!==n&&void 0!==n[W]&&n[W]((0,l.get)(this,e))}},j.getAttr=function(e){return this.get(e)},j.readDOMAttr=function(e){var t=(0,f.getViewElement)(this),n=t,r=n.namespaceURI===h.SVG_NAMESPACE,i=(0,h.normalizeProperty)(n,e),o=i.type,a=i.normalized
...
var Re=ye.extend(f.TextSupport,{classNames:["ember-text-area"],layout:be,tagName:"textarea",attributeBindings:["rows","cols","name","selectionEnd","selectionStart","autocomplete","wrap","lang","dir","value"],rows:null,cols:null})
e.TextArea=Re,Re.toString=function(){return"@ember/component/text-area"}
var Ae,Se=I({id:"VKeIRbyr",block:'{"symbols":["&default"],"statements":[[4,"if",[[26,1]],null,{"statements":[[15,1]],"parameters":[]},{"statements":[[1,[24,0,["linkTitle"]],false]],"parameters":[]}]],"hasEval":false}',meta:{moduleName:"packages/@ember/-internals/glimmer/lib/templates/link-to.hbs"}}),ke=Object.freeze({toString:function(){return"UNDEFINED"}}),xe=Object.freeze({});(Ae=ye.extend({layout:Se,tagName:"a",route:ke,model:ke,models:ke,query:ke,"current-when":null,title:null,rel:null,tabindex:null,target:null,activeClass:"active",loadingClass:"loading",disabledClass:"disabled",replace:!1,attributeBindings:["href","title","rel","tabindex","target"],classNameBindings:["active","loading","disabled","transitioningIn","transitioningOut"],eventName:"click",init:function(){this._super.apply(this,arguments)
...
var n=t[t.length-1]
n&&n.isQueryParams?this.set("query",t.pop().values):this.set("query",ke),0===t.length?this.set("route",ke):this.set("route",t.shift()),this.set("model",ke),this.set("models",t)}else;}})).toString=function(){return"@ember/routing/link-component"},Ae.reopenClass({positionalParams:"params"})
var Te,Ce=Ae
e.LinkComponent=Ce
var Oe=Te
e.DebugStack=Oe
...
function Ne(e,t){return function(e){return null!==e&&"object"==typeof e&&e[Me]}(e)?new He(e,t||"@key"):new Ve(e,t||"@identity")}var Le=function(){function e(e,t){this.length=e,this.keyFor=t,this.position=0}var t=e.prototype
return t.isEmpty=function(){return!1},t.memoFor=function(e){return e},t.next=function(){var e=this.length,t=this.keyFor,n=this.position
if(n>=e)return null
var r=this.valueFor(n),i=this.memoFor(n),o=t(r,i,n)
return this.position++,{key:o,value:r,memo:i}},e}(),je=function(e){function t(t,n,r){var i
...
return(i=e.call(this,n,r)||this).array=t,i}return(0,n.inheritsLoose)(t,e),t.from=function(e,t){var n=e.length
return 0===n?Ue:new this(e,n,t)},t.prototype.valueFor=function(e){return(0,l.objectAt)(this.array,e)},t}(Le),Fe=function(e){function t(t,n,r,i){var o
...
var r=t.prototype
return r.valueFor=function(e){return e.value},r.memoFor=function(e,t){return t},t}(ze),qe=function(e){function t(){return e.apply(this,arguments)||this}(0,n.inheritsLoose)(t,e)
var r=t.prototype
return r.valueFor=function(e){return e.value[1]},r.memoFor=function(e){return e.value[0]},t}(ze),Ue={isEmpty:function(){return!0},next:function(){return null}},He=function(){function e(e,t){this.ref=e,this.keyPath=t,this.valueTag=u.UpdatableTag.create(u.CONSTANT_TAG),this.tag=(0,u.combine)([e.tag,this.valueTag])}var t=e.prototype
return t.iterate=function(){var e,t=this.ref,n=this.valueTag,r=t.value(),i=(0,l.tagFor)(r)
return(0,s.isProxy)(r)&&(r=(0,a._contentFor)(r)),n.inner.update(i),null===(e=r)||"object"!=typeof e&&"function"!=typeof e?Ue:Array.isArray(r)||(0,a.isEmberArray)(r)?Fe.fromIndexable(r,this.keyFor(!0)):s.HAS_NATIVE_SYMBOL&&Ye(r)?qe.from(r,this.keyFor()):We(r)?Fe.fromForEachable(r,this.keyFor()):Fe.fromIndexable(r,this.keyFor(!0))},t.valueReferenceFor=function(e){return new ee(e.value)},t.updateValueReference=function(e,t){e.update(t.value)},t.memoReferenceFor=function(e){return new ee(e.memo)},t.updateMemoReference=function(e,t){e.update(t.memo)},t.keyFor=function(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],t=this.keyPath
switch(t){case"@key":return e?Ge:Je($e)
...
var r=this.keyFor()
return Array.isArray(n)?je.from(n,r):(0,a.isEmberArray)(n)?Ie.from(n,r):s.HAS_NATIVE_SYMBOL&&Ye(n)?Be.from(n,r):We(n)?je.fromForEachable(n,r):Ue},t.valueReferenceFor=function(e){return new ee(e.value)},t.updateValueReference=function(e,t){e.update(t.value)},t.memoReferenceFor=function(e){return new ee(e.memo)},t.updateMemoReference=function(e,t){e.update(t.memo)},t.keyFor=function(){var e=this.keyPath
switch(e){case"@index":return Ke
case"@identity":return Je(Qe)
default:return Je(Xe(e))}},e}()
function We(e){return"function"==typeof e.forEach}function Ye(e){return"function"==typeof e[Symbol.iterator]}function Ke(e,t,n){return String(n)}function Ge(e,t){return t}function $e(e,t){return Qe(t)}function Qe(e){switch(typeof e){case"string":return e
...
var i=t.controller
return{self:void 0===i?h.UNDEFINED_REFERENCE:new Q(i),finalize:(0,m._instrumentStart)("render.outlet",dt,t)}},r.getLayout=function(e,t){var n=e.template.asLayout()
...
"style"===o&&(u=new At(u,bt(t,"isVisible"))),r.setAttribute(o,u,!1,null)}},Rt=at("display: none;"),At=function(e){function t(t,n){var r
...
return st(e)?at(t):t}return Rt},t}(u.CachedReference),St={install:function(e,t,n){n.setAttribute("style",(0,u.map)(bt(t,"isVisible"),this.mapStyleValue),!1,null)},mapStyleValue:function(e){return!1===e?Rt:null}},kt=function(e,t,n,r){var i=n.split(":"),o=i[0],a=i[1],s=i[2]
if(""===o)r.setAttribute("class",h.PrimitiveReference.create(a),!0,null)
else{var u,l=o.indexOf(".")>-1,c=l?o.split("."):[],d=l?_t(t,c):bt(t,o)
u=void 0===a?new xt(d,l?c[c.length-1]:o):new Tt(d,a,s),r.setAttribute("class",u,!1,null)}},xt=function(e){function t(t,n){var r
...
return this.dasherizedPath||(this.dasherizedPath=(0,y.dasherize)(t))}return e||0===e?String(e):null},t}(u.CachedReference),Tt=function(e){function t(t){var n,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
...
"function"==typeof u&&u[K]?n[a]=u:s[W]&&(n[a]=new Mt(s,u)),i[a]=s,r[a]=u}return r.attrs=n,r}var Ot=(0,s.symbol)("REF"),Mt=function(){function e(e,t){this[f.MUTABLE_CELL]=!0,this[Ot]=e,this.value=t}return e.prototype.update=function(e){this[Ot][W](e)},e}()
...
o[c]=t.positional.at(l)}}return{positional:d.EMPTY_ARRAY,named:o}},o.create=function(e,t,n,r,i,o){var a=r.view,s=t.ComponentClass,u=n.named.capture(),l=Ct(u);(function(e,t){e.named.has("id")&&(t.elementId=t.id)})(n,l),l.parentView=a,l[ve]=o,l._target=i.value(),t.template&&(l.layout=t.template)
var c=s.create(l),h=(0,m._instrumentStart)("render.component",Lt,c)
...
var p=new yt(e,c,u,h,d)
return n.named.has("class")&&(p.classRef=n.named.get("class")),e.isInteractive&&d&&c.trigger("willRender"),p},o.getSelf=function(e){return e.component[pe]},o.didCreateElement=function(e,t,n){var r=e.component,i=e.classRef,o=e.environment;(0,f.setViewElement)(r,t),(0,f.setElementView)(t,r)
...
r.setAttribute("id",h.PrimitiveReference.create(c),!1,null)}-1===i.indexOf("style")&&St.install(e,n,r)})(t,a,r,n)
else{var c=r.elementId?r.elementId:(0,s.guidFor)(r)
n.setAttribute("id",h.PrimitiveReference.create(c),!1,null),St.install(t,r,n)}if(i){var d=new xt(i,i.propertyKey)
n.setAttribute("class",d,!1,null)}u&&u.length&&u.forEach(function(e){n.setAttribute("class",h.PrimitiveReference.create(e),!1,null)}),l&&l.length&&l.forEach(function(e){kt(t,r,e,n)}),n.setAttribute("class",h.PrimitiveReference.create("ember-view"),!1,null),"ariaRole"in r&&n.setAttribute("role",bt(r,"ariaRole"),!1,null),r._transitionTo("hasElement"),o.isInteractive&&r.trigger("willInsertElement")},o.didRenderLayout=function(e,t){e.component[ge]=t,e.finalize()},o.getTag=function(e){var t=e.args,n=e.component
...
if(e.finalizer=(0,m._instrumentStart)("render.component",jt,t),n&&!n.tag.validate(r)){var o=Ct(n)
...
function Lt(e){return e.instrumentDetails({initialRender:!0})}function jt(e){return e.instrumentDetails({initialRender:!1})}var It={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!0,elementHook:!0,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0},Ft=new Nt,zt=function(e,t,n,r,i){this.name=e,this.ComponentClass=t,this.handle=n,this.manager=Ft
...
r.view=i
var a=""!==i.tagName
return a||(e.isInteractive&&i.trigger("willRender"),i._transitionTo("hasElement"),e.isInteractive&&i.trigger("willInsertElement")),new yt(e,i,null,o,a)},t}(Nt),qt={dynamicLayout:!1,dynamicTag:!0,prepareArgs:!1,createArgs:!1,attributeHook:!0,elementHook:!0,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0},Ut=function(){function e(e){this.component=e
var t=new Bt(e)
this.manager=t
var n=_.FACTORY_FOR.get(e)
this.state={name:n.fullName.slice(10),capabilities:qt,ComponentClass:n,handle:null}}return e.prototype.getTag=function(e){return e.component[de]},e}(),Ht=function(){function e(e,t){this.view=e,this.outletState=t}var t=e.prototype
...
this.render=function(){var e,l=n.asLayout(),c=l.compile(),d=(0,h.renderMain)(l.compiler.program,t,r,o,a(t,{element:i,nextSibling:null}),c)
...
Wt.splice(t,1)}function Kt(){}var Gt=null
var $t=0
...
return $t++,E.backburner.join(null,Kt)}$t=0,function(){if(null!==Gt){var e=Gt.resolve
Gt=null,E.backburner.join(null,e)}}()})
...
return t.appendOutletView=function(e,t){var i=function(e){if(g.ENV._APPLICATION_TEMPLATE_WRAPPER){var t=(0,r.assign)({},ft,{dynamicTag:!0,elementHook:!0}),i=new(function(e){function r(){return e.apply(this,arguments)||this}(0,n.inheritsLoose)(r,e)
var i=r.prototype
...
this._appendDefinition(e,(0,h.curry)(i),t)},t.appendTo=function(e,t){var n=new Ut(e)
...
e.InertRenderer=Xt
var Jt=function(e){function t(){return e.apply(this,arguments)||this}return(0,n.inheritsLoose)(t,e),t.create=function(e){return new this(e.env,e.rootTemplate,e._viewRegistry,!0,e.builder)},t.prototype.getElement=function(e){return(0,f.getViewElement)(e)},t}(Qt)
...
var hn=on,dn=H(function(e){return y.loc.apply(null,e)}),fn=function(){function e(e){this.resolver=e}var t=e.prototype
...
return!0===i?r>1?(0,y.dasherize)(t.at(1).value()):null:!1===i?r>2?(0,y.dasherize)(t.at(2).value()):null:i}function Sn(e){return"checkbox"===e.positional.at(0).value()?"-checkbox":"-text-field"}function kn(e){var t=e.positional,n=t.at(0).value().split("."),r=n[n.length-1],i=t.at(1).value()
return!0===i?(0,y.dasherize)(r):i||0===i?String(i):""}function xn(e){return e}function Tn(e,t,n,r,i){var o,a
...
function Nn(e){var t,n=e.positional;(t=console).log.apply(t,n.value())}var Ln=(0,s.symbol)("MUT"),jn=(0,s.symbol)("SOURCE")
function In(e){e.positional
var t=e.named
return new A.QueryParams((0,r.assign)({},t.value()))}var Fn=["alt","shift","meta","ctrl"],zn=/^click|mouse|touch/
...
delete f.ActionManager.registeredActions[t]},Un=function(){function e(e,t,n,r,i,o,a,s,u){this.element=e,this.actionId=t,this.actionName=n,this.actionArgs=r,this.namedArgs=i,this.positional=o,this.implicitTarget=a,this.dom=s,this.eventName=this.getEventName(),this.tag=u}var t=e.prototype
...
"function"!=typeof n[Y]?"function"!=typeof n?(r.name=n,s.send?(0,m.flaggedInstrument)("interaction.ember-action",r,function(){s.send.apply(s,[n].concat(e))}):(0,m.flaggedInstrument)("interaction.ember-action",r,function(){s[n].apply(s,e)})):(0,m.flaggedInstrument)("interaction.ember-action",r,function(){n.apply(s,e)}):(0,m.flaggedInstrument)("interaction.ember-action",r,function(){n[Y].apply(n,e)})}),u)},t.destroy=function(){qn(this)},e}(),Hn=function(){function e(){}var t=e.prototype
...
var m=(0,s.uuid)()
return new Un(e,m,a,f,c,h,o,i,d)},t.install=function(e){var t=e.dom,n=e.element,r=e.actionId
...
return null!==i&&(r.component.static(i,[null===t?[]:t,Kn(n),null,null]),!0)}function ar(e,t,n,r,i,o){var a=o.compiler.resolver.lookupComponentDefinition(e,o.referrer)
return null!==a&&(Et(n),o.component.static(a,[t,Kn(n),r,i]),!0)}var sr=[]
...
return Dn.create(n.at(0),n.at(1),n.at(2))},action:function(e,t){var n,r=t.named,i=t.positional.capture().references,o=i[0],a=i[1],s=i.slice(2),c=(a.propertyKey,r.has("target")?r.get("target"):o),h=(d=r.has("value")&&r.get("value"),f=s,f.length>0&&(p=function(e){return f.map(function(e){return e.value()}).concat(e)}),d&&(m=function(e){var t=d.value()
return t&&e.length>0&&(e[0]=(0,l.get)(e[0],t)),e}),p&&m?function(e){return m(p(e))}:p||m||xn)
var d,f,p,m
return(n="function"==typeof a[Y]?Tn(a,a,a[Y],h):(0,u.isConst)(c)&&(0,u.isConst)(a)?Tn(o.value(),c.value(),a.value(),h):function(e,t,n,r,i){return function(){return Tn(e,t.value(),n.value(),r).apply(void 0,arguments)}}(o.value(),c,a,h))[K]=!0,new oe(n)},array:function(e,t){return t.positional.capture()},concat:function(e,t){return new ie(On,t.capture())},get:function(e,t){return Pn.create(t.positional.at(0),t.positional.at(1))},hash:function(e,t){return t.named.capture()},log:function(e,t){return new ie(Nn,t.capture())},mut:function(e,t){var n,r=t.positional.at(0)
if((n=r)&&n[Ln])return r
var i=Object.create(r)
return i[jn]=r,i[Y]=r[W],i[Ln]=!0,i},"query-params":function(e,t){return new ie(In,t.capture())},readonly:function(e,t){var n=function(e){return e[jn]||e}(t.positional.at(0))
return new ae(n)},unbound:function(e,t){return oe.create(t.positional.at(0).value())},unless:function(e,t){var n=t.positional
return Dn.create(n.at(0),n.at(2),n.at(1))},"-class":function(e,t){return new ie(An,t.capture())},"-each-in":function(e,t){return new Pe(t.positional.at(0))},"-input-type":function(e,t){return new ie(Sn,t.capture())},"-normalize-class":function(e,t){return new ie(kn,t.capture())},"-get-dynamic-var":h.getDynamicVar,"-mount":function(e,t){var n=e.env,r=t.positional.at(0),i=t.named.has("model")?t.named.get("model"):void 0
return new Zn(r,n,i)},"-outlet":function(e,t){var n,r=e.dynamicScope()
return n=0===t.positional.length?new u.ConstReference("main"):t.positional.at(0),new ir(new tr(r.outletState,n))},"-assert-implicit-component-helper-argument":Rn},dr={action:{manager:new Hn,state:null}},fr=function(){function e(){this.handles=[void 0],this.objToHandle=new WeakMap,this.builtInHelpers=hr,this.builtInModifiers=dr,this.templateCache=new Map,this.componentDefinitionCache=new Map,this.customManagerCache=new Map,this.templateCacheHits=0,this.templateCacheMisses=0,this.componentDefinitionCount=0,this.helperDefinitionCount=0
var e=new o.Macros;(function(e){var t=e.inlines,n=e.blocks
t.add("outlet",rr),t.add("mount",Jn),t.addMissing(or),n.add("let",Gn),n.addMissing(ar)
...
return-1!==r&&(t=e.slice(r+2),n=e.slice(0,r)),{name:t,namespace:n}},t._lookupComponentDefinition=function(e,t){var n=t.moduleName,r=t.owner,i=e,o=void 0,a=(0,f.lookupComponent)(r,i,cr(n,o)),s=a.layout,u=a.component,l=void 0===u?s:u
if(void 0===l)return null
var c=this.componentDefinitionCache.get(l)
if(void 0!==c)return c
var h=(0,m._instrumentStart)("render.getComponentDefinition",lr,i),d=null
if(void 0!==s&&void 0===u&&g.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS&&(d=new wn(s)),void 0!==u&&void 0!==u.class){var p=cn(u.class)
if(p&&"component"===p.type){var v=p.factory
d=p.internal?new en(v(r),u.class,s):new bn(i,u,v(r),s||r.lookup((0,_.privatize)(D())))}}return null===d&&(d=new zt(i,u||r.factoryFor((0,_.privatize)(P())),null,s)),h(),this.componentDefinitionCache.set(l,d),d},t._lookupComponentManager=function(e,t){if(this.customManagerCache.has(t))return this.customManagerCache.get(t)
var n=e.lookup("component-manager:"+t)
return this.customManagerCache.set(t,n),n},e}(),pr={create:function(){return(new fr).compiler}},mr=I({id:"TfnYOdXy",block:'{"symbols":["&default"],"statements":[[15,1]],"hasEval":false}',meta:{moduleName:"packages/@ember/-internals/glimmer/lib/templates/component.hbs"}}),vr=I({id:"F5xmpEcE",block:'{"symbols":["Checkbox","TextField","@__ARGS__","&attrs"],"statements":[[4,"let",[[29,"component",["-checkbox"],null],[29,"component",["-text-field"],null]],null,{"statements":[[4,"if",[[24,0,["isCheckbox"]]],null,{"statements":[[6,[24,1,[]],[[14,4]],[["@target","@__ARGS__"],[[24,0,["caller"]],[24,3,[]]]]]],"parameters":[]},{"statements":[[6,[24,2,[]],[[14,4]],[["@target","@__ARGS__"],[[24,0,["caller"]],[24,3,[]]]]]],"parameters":[]}]],"parameters":[1,2]},null]],"hasEval":false}',meta:{moduleName:"packages/@ember/-internals/glimmer/lib/templates/input.hbs"}}),gr=I({id:"tzvJXv5n",block:'{"symbols":[],"statements":[[1,[23,"outlet"],false]],"hasEval":false}',meta:{moduleName:"packages/@ember/-internals/glimmer/lib/templates/outlet.hbs"}}),yr="-top-level",br="main",_r=function(){function e(e,t,n,r){this._environment=e,this.renderer=t,this.owner=n,this.template=r
...
if(o.event===t&&(o.target===n&&o.method===r||3===o.kind))return i}return-1}e.meta=f}),e("@ember/-internals/metal",["exports","ember-babel","@ember/polyfills","@ember/-internals/meta","@ember/debug","@ember/-internals/utils","@ember/runloop","@glimmer/reference","@ember/error","ember/version","@ember/-internals/environment","@ember/deprecated-features","@ember/-internals/owner"],function(e,t,n,r,i,o,a,s,u,l,c,h,d){"use strict"
e.computed=Je,e.isComputed=function(e,t){return Boolean(y(e,t))},e.getCacheFor=p,e.getCachedValueFor=m,e.peekCacheFor=v,e.alias=function(e){return We(new nt(e),tt)},e.deprecateProperty=function(e,t,n,r){function i(){}Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set:function(e){i(),Ge(this,n,e)},get:function(){return i(),de(this,n)}})},e._getPath=fe,e.get=de,e.getWithDefault=function(e,t,n){var r=de(e,t)
if(void 0===r)return n
return r},e.set=Ge,e.trySet=function(e,t,n){return Ge(e,t,n,!0)},e.objectAt=me,e.replace=function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:pe
Array.isArray(e)?ge(e,t,n,r):e.replace(t,n,r)},e.replaceInNativeArray=ge,e.addArrayObserver=function(e,t,n){return ye(e,t,n,k,!1)},e.removeArrayObserver=function(e,t,n){return ye(e,t,n,x,!0)},e.arrayContentWillChange=te,e.arrayContentDidChange=ne,e.eachProxyFor=Ee,e.eachProxyArrayWillChange=Z,e.eachProxyArrayDidChange=ee,e.addListener=k,e.hasListeners=function(e,t){var n=(0,r.peekMeta)(e)
if(null===n)return!1
var i=n.matchingListeners(t)
return void 0!==i&&i.length>0},e.on=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
var r=t.pop(),i=t
return(0,o.setListeners)(r,i),r},e.removeListener=x,e.sendEvent=T,e.isNone=function(e){return null==e},e.isEmpty=ot,e.isBlank=at
e.isPresent=function(e){return!at(e)},e.beginPropertyChanges=Y,e.changeProperties=G,e.endPropertyChanges=K,e.notifyPropertyChange=U,e.overrideChains=W,e.defineProperty=$,e.isElementDescriptor=Be,e.nativeDescDecorator=He,e.descriptorForDecorator=b,e.descriptorForProperty=y,e.isClassicDecorator=_,e.setClassicDecorator=E,e.watchKey=Q,e.unwatchKey=X,e.finishChains=function(e){var t=e.readableChainWatchers()
void 0!==t&&t.revalidateAll()
void 0!==e.readableChains()&&e.writableChains(Te)},e.removeChainWatcher=Oe,e.watchPath=Le,e.unwatchPath=je,e.isWatching=function(e,t){return Fe(e,t)>0},e.unwatch=ze,e.watch=Ie,e.watcherCount=Fe,e.getProperties=function(e,t){var n={},r=arguments,i=1
2===arguments.length&&Array.isArray(t)&&(i=0,r=arguments[1])
for(;i<r.length;i++)n[r[i]]=de(e,r[i])
return n},e.setProperties=function(e,t){if(null===t||"object"!=typeof t)return t
return G(function(){for(var n,r=Object.keys(t),i=0;i<r.length;i++)n=r[i],Ge(e,n,t[n])}),t},e.expandProperties=Ke,e.addObserver=be,e.removeObserver=_e,e.mixin=function(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return Ot(e,n),e},e.observer=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
var r=t.pop(),i=t
for(var a=[],s=function(e){return a.push(e)},u=0;u<i.length;++u)Ke(i[u],s)
...
a||n[1]
var u=function(t){var n=(0,d.getOwner)(this)||this.container
return n.lookup(e+":"+(s||t),{source:i,namespace:o})}
0
var l=Je({get:u,set:function(e,t){$(this,e,null,t)}})
return a?l(n[0],n[1],n[2]):l},e.tagForProperty=L,e.tagFor=j,e.markObjectAsDirty=I,e.tracked=oe,e.getCurrentTracker=ue,e.setCurrentTracker=le,e.addNamespace=function(e){ht.unprocessedNamespaces=!0,ft.push(e)},e.classToString=yt,e.findNamespace=function(e){ct||gt()
...
delete pt[t],ft.splice(ft.indexOf(e),1),t in c.context.lookup&&e===c.context.lookup[t]&&(c.context.lookup[t]=void 0)},e.isNamespaceSearchDisabled=function(){return ct},e.setNamespaceSearchDisabled=function(e){ct=Boolean(e)},e.NAMESPACES_BY_ID=e.NAMESPACES=e.Tracker=e.assertNotRendered=e.didRender=e.runInTransaction=e.DEBUG_INJECTION_FUNCTIONS=e.aliasMethod=e.Mixin=e.Libraries=e.libraries=e.ChainNode=e.PROPERTY_DID_CHANGE=e.PROXY_CONTENT=e.ComputedProperty=e._globalsComputed=void 0
var f=new WeakMap
function p(e){var t=f.get(e)
return void 0===t&&(t=new Map,f.set(e,t)),t}function m(e,t){var n=f.get(e)
if(void 0!==n)return n.get(t)}function v(e){return f.get(e)}var g=new WeakMap
...
function R(e){return"string"==typeof e&&-1!==w.get(e)}var A=":change"
function S(e){return e+A}function k(e,t,n,i,o){i||"function"!=typeof n||(i=n,n=null),(0,r.meta)(e).addToListeners(t,n,i,!0===o)}function x(e,t,n,i){i||"function"!=typeof n||(i=n,n=null)
var o=(0,r.meta)(e)
...
l&&(c&&x(e,t,u,l),u||(u=e),"string"==typeof l&&(l=u[l]),l.apply(u,n))}return!0}var C,O,M,P,D=function(){function e(){this.added=new Map,this.queue=[]}var t=e.prototype
...
function N(){return s.DirtyableTag.create()}function L(e,t,n){var i=typeof e
if("function"!==i&&("object"!==i||null===e))return s.CONSTANT_TAG
var a=void 0===n?(0,r.meta)(e):n
if((0,o.isProxy)(e))return j(e,a)
var u=a.writableTags(),l=u[t]
return l||(u[t]=N())}function j(e,t){return"object"==typeof e&&null!==e?(void 0===t?(0,r.meta)(e):t).writableTag(N):s.CONSTANT_TAG}function I(e,t,n){var r=n.readableTag()
...
void 0===a&&(a=new Set,r.set(t,a)),a.has(n)||i.forEachInDeps(n,function(n){void 0!==(o=y(t,n,i))&&o._suspended===t||e(t,n,i)})})(U,e,t,H,n),r&&(H.clear(),V=!0)}(e,t,i),function(e,t,n){var r=n.readableChainWatchers()
void 0!==r&&r.notify(t,!0,U)}(0,t,i),function(e,t,n){if(n.isSourceDestroying())return
var r=S(t)
q>0?B.add(e,t,r):T(e,r,[e,t])}(e,t,i)),z in e&&e[z](t),null!==i){if(i.isSourceDestroying())return
I(e,t,i)}0}}var H=new Map,V=!0
function W(e,t,n){var r=n.readableChainWatchers()
void 0!==r&&r.revalidate(t)}function Y(){q++}function K(){--q<=0&&B.flush()}function G(e){Y()
...
return{enumerable:!0,configurable:!0,get:function(){return se&&se.add(L(this,t)),i in this||(this[i]="function"==typeof r?r.call(this):void 0),this[i]},set:function(e){j(this).inner.dirty(),C(L(this,t)),this[i]=e,ce()}}}e.Tracker=ie
var se=null
...
function de(e,t){var n,r=typeof e,i="object"===r,o=i||"function"===r
if(R(t))return o?fe(e,t):void 0
if(o){var a=y(e,t)
if(void 0!==a)return a.get(e,t)
n=e[t]}else n=e[t]
return void 0!==n||!i||t in e||"function"!=typeof e.unknownProperty?n:e.unknownProperty(t)}function fe(e,t){for(var n=e,r="string"==typeof t?t.split("."):t,i=0;i<r.length;i++){if(null==n||n.isDestroyed)return
n=de(n,r[i])}return n}e.PROXY_CONTENT=he
...
e.splice.apply(e,[t+i,0].concat(o))}}ne(e,t,n,r.length)}function ye(e,t,n,r,i){var o=n&&n.willChange||"arrayWillChange",a=n&&n.didChange||"arrayDidChange",s=de(e,"hasArrayObservers")
return r(e,"@array:before",t,o),r(e,"@array:change",t,a),s===i&&U(e,"hasArrayObservers"),e}function be(e,t,n,r){k(e,S(t),n,r),Ie(e,t)}function _e(e,t,n,r){ze(e,t),x(e,S(t),n,r)}function Ee(e){var t=J.get(e)
...
for(var u in o)a>0&&Re(e,u,this,t,a),U(this,u,s)}},t.willWatchProperty=function(e){this.beginObservingContentKey(e)},t.didUnwatchProperty=function(e){this.stopObservingContentKey(e)},t.beginObservingContentKey=function(e){var t=this._keys
if(void 0===t&&(t=this._keys=Object.create(null)),t[e])t[e]++
else{t[e]=1
var n=this._content
Re(n,e,this,0,n.length)}},t.stopObservingContentKey=function(e){var t=this._keys
if(void 0!==t&&t[e]>0&&--t[e]<=0){var n=this._content
Ae(n,e,this,0,n.length)}},t.contentKeyDidChange=function(e,t){U(this,t)},e}()
function Re(e,t,n,r,i){for(;--i>=r;){var o=me(e,i)
o&&be(o,t,n,"contentKeyDidChange")}}function Ae(e,t,n,r,i){for(;--i>=r;){var o=me(e,i)
o&&_e(o,t,n,"contentKeyDidChange")}}function Se(e){return"object"==typeof e&&null!==e}var ke=function(){function e(){this.chains=Object.create(null)}var t=e.prototype
...
function xe(){return new ke}function Te(e){return new Ne(null,null,e)}function Ce(e,t,n){var i=(0,r.meta)(e)
i.writableChainWatchers(xe).add(t,n),Q(e,t,i)}function Oe(e,t,n,i){if(Se(e)){var o=void 0===i?(0,r.peekMeta)(e):i
...
Se(r)&&(this.object=r,Ce(r,t,this))}}var t=e.prototype
...
return!(void 0!==r&&!1===r._volatile)}(e,t,n)?de(e,t):m(e,t)}(e,this.key)}return this.content},t.destroy=function(){null===this.parent?function(e){for(De(e);Me.length>0;){var t=Me.pop()
...
n!==this.object&&(Oe(this.object,this.key,this),Se(n)?(this.object=n,Ce(n,this.key,this)):this.object=void 0),this.content=void 0}var r,i=this.chains
...
o>0&&(i.writeWatching(t,o-1),1===o&&i.writableChains(Te).remove(t))}}function Ie(e,t,n){R(t)?Le(e,t,n):Q(e,t,n)}function Fe(e,t){var n=(0,r.peekMeta)(e)
return null!==n&&n.peekWatching(t)||0}function ze(e,t,n){R(t)?je(e,t,n):X(e,t,n)}function Be(e){var t=e[0],n=e[1],r=e[2]
return 3===e.length&&("function"==typeof t||"object"==typeof t&&null!==t)&&"string"==typeof n&&("object"==typeof r&&null!==r&&"enumerable"in r&&"configurable"in r||void 0===r)}function qe(e,t,n,r){var i=e._dependentKeys
...
t+=n.substring(0,r)
a=l.length
for(;u<a;)(o=c.indexOf("{"))<0?i((t+l[u++]+c).replace(Ye,".[]")):e(t+l[u++],c,o,i)}("",e,n,t)}function Ge(e,t,n,i){if(!e.isDestroyed){if(R(t))return function(e,t,n,r){var i=t.split("."),o=i.pop()
var a=fe(e,i)
...
return void 0!==s?(s.set(e,t,n),n):(void 0!==(o=e[t])||"object"!=typeof e||t in e||"function"!=typeof e.setUnknownProperty?(e[t]=n,o!==n&&U(e,t,a)):e.setUnknownProperty(t,n),n)}}function $e(){}var Qe=function(e){function n(t){var n;(n=e.call(this)||this)._volatile=!1,n._readOnly=!1,n._suspended=void 0,n._hasConfig=!1,n._getter=void 0,n._setter=void 0
...
if(o&&a===s)return s
var u=(0,r.meta)(e)
return o||qe(this,e,t,u),i.set(t,s),U(e,t,u),s},i.teardown=function(t,n,r){if(!this._volatile){var i=v(t)
void 0!==i&&i.delete(n)&&Ue(this,t,n,r)}e.prototype.teardown.call(this,t,n,r)},n}(Ve)
...
var i=n.prototype
return i.setup=function(t,n,r,i){e.prototype.setup.call(this,t,n,r,i),i.peekWatching(n)>0&&this.consume(t,n,i)},i.teardown=function(t,n,r){this.unconsume(t,n,r),e.prototype.teardown.call(this,t,n,r)},i.willWatch=function(e,t,n){this.consume(e,t,n)},i.get=function(e,t){var n=de(e,this.altKey)
...
r.get(t)!==et&&(r.set(t,et),qe(this,e,t,n))},i.set=function(e,t,n){return Ge(e,this.altKey,n)},i.readOnly=function(){this.set=rt},i.oneWay=function(){this.set=it},n}(Ve)
function rt(e,t){throw new u.default("Cannot set read-only property '"+t+"' on object: "+(0,o.inspect)(e))}function it(e,t,n){return $(e,t,null),Ge(e,t,n)}function ot(e){var t=null==e
if(t)return t
if("number"==typeof e.size)return!e.size
var n=typeof e
if("object"===n){var r=de(e,"size")
if("number"==typeof r)return!r}if("number"==typeof e.length&&"function"!==n)return!e.length
if("object"===n){var i=de(e,"length")
...
var lt=Object.prototype.hasOwnProperty,ct=!1,ht={_set:0,_unprocessedNamespaces:!1,get unprocessedNamespaces(){return this._unprocessedNamespaces},set unprocessedNamespaces(e){this._set++,this._unprocessedNamespaces=e}},dt=!1,ft=[]
e.NAMESPACES=ft
...
if(e&&(mt(),ht.unprocessedNamespaces=!1),e||dt){for(var t=ft,n=0;n<t.length;n++)vt(t[n])
dt=!1}}function yt(){var e=(0,o.getName)(this)
...
Array.isArray
function Et(e){return"function"==typeof e&&!1!==e.isMethod&&e!==Boolean&&e!==Object&&e!==Number&&e!==Array&&e!==Date&&e!==String}function wt(e){return"function"==typeof e.get||"function"==typeof e.set}var Rt,At={}
function St(e,t,n,r){var i=n[e]||r[e]
return t[e]&&(i=i?_t.call(i,t[e]):t[e]),i}function kt(e,t,n,r,i){if(void 0!==i[t])return n
var a=r[t]
return void 0===a&&void 0===y(e,t)&&(a=e[t]),"function"==typeof a?(0,o.wrap)(n,a):n}function xt(e,t,r,i,a,s,u,l){_(r)?(a[t]=function(e,t,n,r,i,a){var s,u=b(n)
...
Et(c)?(u=!0,s[l]=kt(e,l,c,a,{})):s[l]=c}return u&&(s._super=o.ROOT),s}(e,t,r,s):Et(r)&&(r=kt(e,t,r,s,a)),a[t]=void 0,s[t]=r)}function Tt(e,t,n,r){if(n)for(var i=0;i<n.length;i++)r(e,n[i],null,t)}function Ct(e,t,n,r){"function"==typeof n&&(Tt(e,t,(0,o.getObservers)(n),_e),Tt(e,t,(0,o.getListeners)(n),x)),"function"==typeof r&&(Tt(e,t,(0,o.getObservers)(r),be),Tt(e,t,(0,o.getListeners)(r),k))}function Ot(e,t){var n,i,a,s={},u={},l=(0,r.meta)(e),c=[]
e._super=o.ROOT,function e(t,n,r,i,o,a){var s,u,l,c,h,d,f
function p(e){delete r[e],delete i[e]}for(var m=0;m<t.length;m++)if(s=t[m],d=n,(u=(f=s)instanceof Nt?d.hasMixin(f)?At:(d.addMixin(f),f.properties):f)!==At)if(u){for(l in o.willMergeMixin&&o.willMergeMixin(u),c=St("concatenatedProperties",u,i,o),h=St("mergedProperties",u,i,o),u)u.hasOwnProperty(l)&&(a.push(l),xt(o,l,u[l],n,r,i,c,h))
...
for(var d=0;d<c.length;d++)if("constructor"!==(n=c[d])&&u.hasOwnProperty(n)){if(a=s[n],i=u[n],h.ALIAS_METHOD)for(;i&&i instanceof Mt;){var f=Rt(e,i,s,u)
a=f.desc,i=f.value}void 0===a&&void 0===i||(void 0!==y(e,n)?Ct(e,n,null,i):Ct(e,n,e[n],i),$(e,n,a,i,l))}return e}h.ALIAS_METHOD&&(Rt=function(e,t,n,r){var i,o=t.methodName,a=n[o],s=r[o]
...
wt(i)?r[n]=He(i):r[n]=e[n]}),r}}return e}(t),this.mixins=Lt(e),this.ownerConstructor=void 0,this._without=void 0}e.create=function(){dt=!0
...
return this.mixins=this.mixins.concat(Lt(n)),this}},t.apply=function(e){return Ot(e,[this])},t.applyPartial=function(e){return Ot(e,[this])},t.detect=function(t){if("object"!=typeof t||null===t)return!1
...
s(this,y,{resetNamespace:i.resetNamespace}),this.options.addRouteForEngine(y,_),y=u+"_error",b="application_error",_=(0,n.assign)({localFullName:b},h),s(this,y,{resetNamespace:i.resetNamespace,path:f}),this.options.addRouteForEngine(y,_)}this.options.addRouteForEngine(c,g),this.push(d,c,l)},e}()
...
R=y(R)
var A=b.type||(0,o.typeOf)(R),S=this.serializeQueryParam(R,w,A),k=a+":"+g,x={undecoratedDefaultValue:(0,r.get)(u,g),defaultValue:R,serializedDefaultValue:S,serializedValue:S,type:A,urlKey:w,prop:g,scopedPropertyName:k,controllerName:a,route:this,parts:E,values:null,scope:_}
...
function v(e){T(this),this._cancelSlowTransitionTimer(),this.notifyPropertyChange("url"),this.set("currentState",this.targetState),(0,l.once)(this,this.trigger,"didTransition")}function g(e,t,n){(0,l.once)(this,this.trigger,"willTransition",n)}function y(){return this}e.triggerEvent=k,e.default=void 0
...
var c,h
e.isEmberArray=function(e){return e&&e[f]},e.uniqBy=m,e.removeAt=w,e.isArray=A,e.default=e.MutableArray=e.NativeArray=e.A=void 0
...
return(0,t.replace)(e,n,r,d),e}function R(e,n,r){return(0,t.replace)(e,n,0,[r]),r}function A(e){var t=e
...
return e.enumerable=!1,e}function k(e){return this.map(function(n){return(0,t.get)(n,e)})}var x=t.Mixin.create(i.default,((c={})[f]=!0,c.objectsAt=function(e){var n=this
...
e.call(t,i,r,this)}return this},c.getEach=k,c.setEach=function(e,n){return this.forEach(function(r){return(0,t.set)(r,e,n)})},c.map=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,n=O()
return this.forEach(function(r,i,o){return n[i]=e.call(t,r,i,o)}),n},c.mapBy=k,c.filter=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,n=O()
...
return this.filter(t)},c)),T=t.Mixin.create(x,u.default,{clear:function(){var e=this.length
...
e.MutableArray=T
var C=t.Mixin.create(T,s.default,{objectAt:function(e){return this[e]},replace:function(e,n){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:d
return(0,t.replaceInNativeArray)(this,e,n,r),this}})
e.NativeArray=C
var O,M=["length"]
C.keys().forEach(function(e){Array.prototype[e]&&M.push(e)}),e.NativeArray=C=(h=C).without.apply(h,M),e.A=O,a.ENV.EXTEND_PROTOTYPES.Array?(C.apply(Array.prototype),e.A=O=function(e){return e||[]}):e.A=O=function(e){return e||(e=[]),x.detect(e)?e:C.apply(e)}
var P=x
...
if(void 0!==t)for(var o=e.concatenatedProperties,u=e.mergedProperties,l=void 0!==o&&o.length>0,c=void 0!==u&&u.length>0,h=Object.keys(t),d=0;d<h.length;d++){var f=h[d],p=t[f],m=(0,s.descriptorForProperty)(e,f,n),v=void 0!==m
if(!v){var g=e[f]
...
if(!S.has(t)&&y(t))return k(e,k(t,g))
return k(e,t)},e.getObservers=E,e.getListeners=A,e.setObservers=_,e.setListeners=R,e.inspect=function(e){if("number"==typeof e&&2===arguments.length)return this
...
function R(e,t){t&&w.set(e,t)}function A(e){return w.get(e)}var S=new t._WeakSet
function k(e,t){function n(){var n=this._super
this._super=t
var r=e.apply(this,arguments)
return this._super=n,r}return S.add(n),_(n,E(e)),R(n,A(e)),n}var x=Object.prototype.toString,T=Function.prototype.toString,C=Array.isArray,O=Object.keys,M=JSON.stringify,P=100,D=4,N=/^[\w$]+$/
...
break}r+=L(e[i],t,n)}return r+=" ]"}(e,n+1,r):function(e,t,n){if(t>D)return"[Object]"
for(var r="{",i=O(e),o=0;o<i.length;o++){if(r+=0===o?" ":", ",o>=P){r+="... "+(i.length-P)+" more keys"
break}var a=i[o]
r+=j(a)+": "+L(e[a],t,n)}return r+=" }"}(e,n+1,r)}function j(e){return N.test(e)?e:M(e)}function I(e,t){return null!=e&&"function"==typeof e[t]}var F=Array.isArray
var z=new WeakMap
var B=Object.prototype.toString
function q(e){return null==e}var U="function"==typeof Symbol&&"[object Symbol]"===Object.prototype.toString.call(Symbol())
...
d.push(m.before(e,f,c))}return function(){for(var t=s(),n=0;n<a.length;n++){var r=a[n]
"function"==typeof r.after&&r.after(e,t,c,d[n])}h&&console.timeEnd(u)}}e.flaggedInstrument=a,e.flaggedInstrument=a=function(e,t,n){return n()}}),e("@ember/modifier/index",["exports","@ember/-internals/glimmer"],function(e,t){"use strict"
...
return[n,r=r||"asc"]})}(u)
if(0===d.length){var f=h?"[]":e+".[]";(0,n.addObserver)(this,f,c),l=[f]}else l=d.map(function(t){var r=t[0],i=h?"@each."+r:e+".@each."+r
return(0,n.addObserver)(s,i,c),i})
i.set(this,l)
var p=h?this:(0,n.get)(this,e)
return(0,r.isArray)(p)?0===d.length?(0,r.A)(p.slice()):function(e,t){return(0,r.A)(e.slice().sort(function(e,i){for(var o=0;o<t.length;o++){var a=t[o],s=a[0],u=a[1],l=(0,r.compare)((0,n.get)(e,s),(0,n.get)(i,s))
if(0!==l)return"desc"===u?-1*l:l}return 0}))}(p,d):(0,r.A)()}).readOnly()}(e,i)},e.union=void 0
var c=l
...
e.loc=_,e.w=E,e.decamelize=w,e.dasherize=R,e.camelize=A,e.classify=S,e.underscore=k,e.capitalize=x,Object.defineProperty(e,"_getStrings",{enumerable:!0,get:function(){return t.getStrings}}),Object.defineProperty(e,"_setStrings",{enumerable:!0,get:function(){return t.setStrings}})
...
return _(this,t)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return A(this)}},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return w(this)}},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return R(this)}},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return k(this)}},classify:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return S(this)}},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return x(this)}}})}),e("@ember/string/lib/string_registry",["exports"],function(e){"use strict"
...
var w=function(){function e(e,t,n){this.main=e,this.trustingGuardedAppend=t,this.cautiousGuardedAppend=n}return e.compile=function(t){return new e(this.std(t,function(e){return e.main()}),this.std(t,function(e){return e.stdAppend(!0)}),this.std(t,function(e){return e.stdAppend(!1)}))},e.std=function(e,t){return x.build(e,t)},e.prototype.getAppend=function(e){return e?this.trustingGuardedAppend:this.cautiousGuardedAppend},e}(),R=function(){function e(e,t,n){this.macros=e,this.program=t,this.resolver=n,this.initialize()}var t=e.prototype
...
return(i=e.call(this,t,r?r.block.symbols.length:0)||this).containingLayout=r,i.component=new S((0,n.assertThisInitialized)(i)),i.expressionCompiler=function(){if(f)return f
var e=f=new p
...
var k,x=function(){function e(e){this.iterator=null
var t=new S(e)
this.artifacts=t}return e.prototype.next=function(){var e=this.artifacts,t=(this.iterator=this.iterator||e.iterate()).next()
return null===t?null:e.append(t)},e}()
e.ReferenceIterator=x,function(e){e[e.Append=0]="Append",e[e.Prune=1]="Prune",e[e.Done=2]="Done"}(k||(k={}))
...
return new mt(a)},e.renderComponent=function(e,t,n,r,i){var o,a=arguments.length>5&&void 0!==arguments[5]?arguments[5]:{},s=pt.empty(e,t,n,r),u=s.constants.resolver,l=L(u,i,null),c=l.manager,h=l.state
if(!q(F(c.getCapabilities(h)),c))throw new Error("Cannot invoke components with dynamic layouts as a root component.")
o=c.getLayout(h,u)
...
s.stack.push(t)}),s.args.setup(s.stack,p,f,0,!1),s.stack.push(s.args),s.stack.push(o),s.stack.push(l),new mt(s)},e.setDebuggerCallback=function(e){Y=e},e.resetDebuggerCallback=function(){Y=W},e.getDynamicVar=function(e,t){var n=e.dynamicScope(),r=t.positional.at(0)
...
return new _(e,t)},e.isWhitespace=function(e){return oe.test(e)},e.normalizeProperty=Re,e.clientBuilder=function(e,t){return Ue.forInitialRender(e,t)},e.rehydrationBuilder=function(e,t){return _t.forInitialRender(e,t)},e.isSerializationFirstNode=yt,e.capabilityFlagsFrom=F,e.hasCapability=z,e.Cursor=e.ConcreteBounds=e.SERIALIZATION_FIRST_NODE_STRING=e.RehydrateBuilder=e.NewElementBuilder=e.DOMTreeConstruction=e.IDOMChanges=e.SVG_NAMESPACE=e.DOMChanges=e.CurriedComponentDefinition=e.MINIMAL_CAPABILITIES=e.DEFAULT_CAPABILITIES=e.DefaultEnvironment=e.Environment=e.Scope=e.EMPTY_ARGS=e.DynamicAttribute=e.SimpleDynamicAttribute=e.RenderResult=e.UpdatingVM=e.LowLevelVM=e.ConditionalReference=e.PrimitiveReference=e.UNDEFINED_REFERENCE=e.NULL_REFERENCE=void 0
...
function E(e){return w(e)?"":String(e)}function w(e){return null==e||"function"!=typeof e.toString}function R(e){return"object"==typeof e&&null!==e&&"function"==typeof e.toHTML}function A(e){return"object"==typeof e&&null!==e&&"number"==typeof e.nodeType}function S(e){return"string"==typeof e}e.CurriedComponentDefinition=_
...
e!==n&&((t=w(e)?"":S(e)?e:String(e))!==n&&(this.node.nodeValue=this.lastValue=t))},n}(s),x=function(e){function n(){return e.apply(this,arguments)||this}return(0,t.inheritsLoose)(n,e),n.create=function(e){return new n(e)},n.prototype.toBool=function(e){return b(e)},n}(m),T=function(){function e(e){this.inner=e,this.tag=e.tag}return e.prototype.value=function(){var e,t=this.inner.value()
return function(e){return S(e)||w(e)||"boolean"==typeof e||"number"==typeof e}(t)?1:(e=t)&&e[y]?0:R(t)?3:function(e){return A(e)&&11===e.nodeType}(t)?4:A(t)?5:1},e}()
...
var p=o.getTag(d);(0,r.isConstTag)(p)||e.updateWith(new D(p,o,d))})
...
o.state=f
var p=s.getTag(f)
z(u,256)&&!(0,r.isConstTag)(p)&&e.updateWith(new H(p,f,s,l))}),a.add(82,function(e,t){var n=t.op1,r=e.fetchValue(n),i=r.manager,o=r.state,a=i.getDestructor(o)
...
function q(e,t){return!1===z(e,1)}function U(e,t,n,r,i){var o=n.table.symbols.indexOf(e),a=r.get(t);-1!==o&&i.scope().bindBlock(o+1,a),n.lookup&&(n.lookup[e]=a)}a.add(93,function(e,t){var n=t.op1,r=e.fetchValue(n),o=r.definition,a=r.state,s=o.manager,u=e.fetchValue(i.Register.t0)
...
b[w]=R}if(y)for(var A=0;A<m.length;A++){var S=A+1,k=y[m[A]]
void 0!==k&&g.bind(S,k)}g.bindPartialMap(b),e.pushFrame(),e.call(p)})
...
return"attr"===a?ke(r,s,i):function(e,t,n){if(Ee(e,t))return new Oe(t,n)
...
return new Ce(t,n)}(r,s,i)}function ke(e,t,n){return Ee(e,t)?new Me(n):new Te(n)}var xe=function(e){this.attribute=e}
...
n?t.removeAttributeNS(n,this.normalizedName):t.removeAttribute(this.normalizedName)},n}(xe),Oe=function(e){function n(){return e.apply(this,arguments)||this}(0,t.inheritsLoose)(n,e)
var r=n.prototype
...
case 25:return this.returnTo(e.op1)}},t.evaluateSyscall=function(e,t){a.evaluate(t,e,e.type)},e}(),Be=function(){function e(e){this.node=e}return e.prototype.firstNode=function(){return this.node},e}(),qe=function(){function e(e){this.node=e}return e.prototype.lastNode=function(){return this.node},e}(),Ue=function(){function e(e,t,r){this.constructing=null,this.operations=null,this.cursorStack=new n.Stack,this.blockStack=new n.Stack,this.pushElement(t,r),this.env=e,this.dom=e.getAppendOperations(),this.updateOperations=e.getDOM()}e.forInitialRender=function(e,t){var n=new this(e,t.element,t.nextSibling)
...
if(e&&e.length)for(var t=0;t<e.length;t++)e[t].destroy()},t.parentElement=function(){return this.parent},t.firstNode=function(){return this.first.firstNode()},t.lastNode=function(){return this.last.lastNode()},t.openElement=function(e){this.didAppendNode(e),this.nesting++},t.closeElement=function(){this.nesting--},t.didAppendNode=function(e){0===this.nesting&&(this.first||(this.first=new Be(e)),this.last=new qe(e))},t.didAppendBounds=function(e){0===this.nesting&&(this.first||(this.first=e),this.last=e)},t.newDestroyable=function(e){this.destroyables=this.destroyables||[],this.destroyables.push(e)},t.finalize=function(e){null===this.first&&e.appendComment("")},e}(),Ve=function(e){function n(){return e.apply(this,arguments)||this}return(0,t.inheritsLoose)(n,e),n.prototype.destroy=function(){e.prototype.destroy.call(this),Z(this)},n}(He),We=function(e){function n(){return e.apply(this,arguments)||this}return(0,t.inheritsLoose)(n,e),n.prototype.reset=function(e){var t=this.destroyables
...
case 4:return-(e>>3)
default:throw(0,n.unreachable)()}}(e)}}(t)},r.reset=function(){this.inner.reset(),this.js.length=0},(0,t.createClass)(e,[{key:"length",get:function(){return this.inner.len()}}]),e}(),$e=function(){function e(e,t,n){this.stack=e,this.fp=t,this.sp=n}e.empty=function(){return new this(new Ge,0,-1)},e.restore=function(e){for(var t=new Ge,n=0;n<e.length;n++)t.write(n,e[n])
...
return t&&t[1]?Number(t[1]):null}function Rt(e){return 1===e.nodeType}function At(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function St(e){return 8===e.nodeType&&"% %"===e.nodeValue}function kt(e,t){for(var n=0;n<e.length;n++){var r=e[n]
...
e=o[0],t=o[1],void 0===(r=o[2])?i=0:u(i=r.pop())||(n=!0===i,i=r.pop())}return[e,t,r,i=parseInt(i,10),n]}var E=0,w=0,R=0,A=0,S=0,k=0,x=0,T=0,C=0,O=0,M=0,P=0,D=0,N=0,L=0,j=0,I=0,F=0,z=0,B=0,q=0,U=function(){function e(e,t){var n=this
...
return!1!==this._autorun?(e=n,this._cancelAutorun()):(null!==n&&(q++,this.instanceStack.push(n)),B++,e=this.currentInstance=new m(this.queueNames,t),A++,this._trigger("begin",e,n)),this._onBegin(e,n),e},n.end=function(){R++,this._end(!1)},n.on=function(e,t){if("function"!=typeof t)throw new TypeError("Callback must be a function")
...
this._timers.splice(m,0,d,e,n,r,i,v),this._timers.splice(c,s)}0===c&&this._reinstallTimerTimeout()}return e},n.cancelTimers=function(){j++,this._clearTimerTimeout(),this._timers=[],this._cancelAutorun()},n.hasTimers=function(){return this._timers.length>0||this._autorun},n.cancel=function(e){if(I++,null==e)return!1
var t=typeof e
...
n?n(e,t):t(),this._autorun=!0},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:w,end:R,events:{begin:A,end:0},autoruns:{created:F,completed:z},run:S,join:k,defer:x,schedule:T,scheduleIterable:C,deferOnce:O,scheduleOnce:M,setTimeout:P,later:D,throttle:N,debounce:L,cancelTimers:j,cancel:I,loops:{total:B,nested:q}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function i(e){return e}}),e("ember/index",["exports","require","@ember/-internals/environment","node-module","@ember/-internals/utils","@ember/-internals/container","@ember/instrumentation","@ember/-internals/meta","@ember/-internals/metal","@ember/canary-features","@ember/debug","backburner","@ember/-internals/console","@ember/controller","@ember/controller/lib/controller_mixin","@ember/string","@ember/service","@ember/object","@ember/object/computed","@ember/-internals/runtime","@ember/-internals/glimmer","ember/version","@ember/-internals/views","@ember/-internals/routing","@ember/-internals/extension-support","@ember/error","@ember/runloop","@ember/-internals/error-handling","@ember/-internals/owner","@ember/application","@ember/application/globals-resolver","@ember/application/instance","@ember/engine","@ember/engine/instance","@ember/polyfills","@ember/deprecated-features"],function(e,t,n,r,i,o,a,s,u,l,c,h,d,f,p,m,v,g,y,b,_,E,w,R,A,S,k,x,T,C,O,M,P,D,N,L){"use strict"
e.default=void 0
var j="object"==typeof n.context.imports.Ember&&n.context.imports.Ember||{}
j.isNamespace=!0,j.toString=function(){return"Ember"},Object.defineProperty(j,"ENV",{get:n.getENV,enumerable:!1}),Object.defineProperty(j,"lookup",{get:n.getLookup,set:n.setLookup,enumerable:!1}),L.EMBER_EXTEND_PROTOTYPES&&Object.defineProperty(j,"EXTEND_PROTOTYPES",{enumerable:!1,get:function(){return n.ENV.EXTEND_PROTOTYPES}}),j.getOwner=T.getOwner,j.setOwner=T.setOwner,j.Application=C.default,j.DefaultResolver=j.Resolver=O.default,j.ApplicationInstance=M.default,j.Engine=P.default,j.EngineInstance=D.default,j.assign=N.assign,j.merge=N.merge,j.generateGuid=i.generateGuid,j.GUID_KEY=i.GUID_KEY,j.guidFor=i.guidFor,j.inspect=i.inspect,j.makeArray=i.makeArray,j.canInvoke=i.canInvoke,j.tryInvoke=i.tryInvoke,j.wrap=i.wrap,j.uuid=i.uuid,Object.defineProperty(j,"NAME_KEY",{enumerable:!1,get:function(){return i.NAME_KEY}}),j.Container=o.Container,j.Registry=o.Registry,j.assert=c.assert,j.warn=c.warn,j.debug=c.debug,j.deprecate=c.deprecate
j.deprecateFunc=c.deprecateFunc,j.runInDebug=c.runInDebug,j.Error=S.default,j.Debug={registerDeprecationHandler:c.registerDeprecationHandler,registerWarnHandler:c.registerWarnHandler,isComputed:u.isComputed},j.instrument=a.instrument,j.subscribe=a.subscribe,j.Instrumentation={instrument:a.instrument,subscribe:a.subscribe,unsubscribe:a.unsubscribe,reset:a.reset},j.run=k._globalsRun,j.run.backburner=k.backburner,j.run.begin=k.begin,j.run.bind=k.bind,j.run.cancel=k.cancel,j.run.debounce=k.debounce,j.run.end=k.end,j.run.hasScheduledTimers=k.hasScheduledTimers,j.run.join=k.join,j.run.later=k.later,j.run.next=k.next,j.run.once=k.once,j.run.schedule=k.schedule,j.run.scheduleOnce=k.scheduleOnce,j.run.throttle=k.throttle,j.run.cancelTimers=k.cancelTimers,Object.defineProperty(j.run,"currentRunLoop",{get:k.getCurrentRunLoop,enumerable:!1})
var I=u._globalsComputed
if(j.computed=I,j._descriptor=u.nativeDescDecorator,j._tracked=u.tracked,I.alias=u.alias,j.cacheFor=u.getCachedValueFor,j.ComputedProperty=u.ComputedProperty,Object.defineProperty(j,"_setComputedDecorator",{get:function(){return u.setClassicDecorator}}),j._setClassicDecorator=u.setClassicDecorator,j.meta=s.meta,j.get=u.get,j.getWithDefault=u.getWithDefault,j._getPath=u._getPath,j.set=u.set,j.trySet=u.trySet,j.FEATURES=(0,N.assign)({isEnabled:l.isEnabled},l.FEATURES),j._Cache=i.Cache,j.on=u.on,j.addListener=u.addListener,j.removeListener=u.removeListener,j.sendEvent=u.sendEvent,j.hasListeners=u.hasListeners,j.isNone=u.isNone,j.isEmpty=u.isEmpty,j.isBlank=u.isBlank,j.isPresent=u.isPresent,j.notifyPropertyChange=u.notifyPropertyChange,j.overrideChains=u.overrideChains,j.beginPropertyChanges=u.beginPropertyChanges,j.endPropertyChanges=u.endPropertyChanges,j.changeProperties=u.changeProperties,j.platform={defineProperty:!0,hasPropertyAccessors:!0},j.defineProperty=u.defineProperty,j.watchKey=u.watchKey,j.unwatchKey=u.unwatchKey,j.removeChainWatcher=u.removeChainWatcher,j._ChainNode=u.ChainNode,j.finishChains=u.finishChains,j.watchPath=u.watchPath,j.unwatchPath=u.unwatchPath,j.watch=u.watch,j.isWatching=u.isWatching,j.unwatch=u.unwatch,j.destroy=s.deleteMeta,j.libraries=u.libraries,j.getProperties=u.getProperties,j.setProperties=u.setProperties,j.expandProperties=u.expandProperties,j.addObserver=u.addObserver,j.removeObserver=u.removeObserver,j.aliasMethod=u.aliasMethod,j.observer=u.observer,j.mixin=u.mixin,j.Mixin=u.Mixin,Object.defineProperty(j,"onerror",{get:x.getOnerror,set:x.setOnerror,enumerable:!1}),Object.defineProperty(j,"testing",{get:c.isTesting,set:c.setTesting,enumerable:!1}),j._Backburner=h.default,L.LOGGER&&(j.Logger=d.default),j.A=b.A,j.String={loc:m.loc,w:m.w,dasherize:m.dasherize,decamelize:m.decamelize,camelize:m.camelize,classify:m.classify,underscore:m.underscore,capitalize:m.capitalize},j.Object=b.Object,j._RegistryProxyMixin=b.RegistryProxyMixin,j._ContainerProxyMixin=b.ContainerProxyMixin,j.compare=b.compare,j.copy=b.copy,j.isEqual=b.isEqual,j.inject=function(){},j.inject.service=v.inject,j.inject.controller=f.inject,j.Array=b.Array,j.Comparable=b.Comparable,j.Enumerable=b.Enumerable,j.ArrayProxy=b.ArrayProxy,j.ObjectProxy=b.ObjectProxy,j.ActionHandler=b.ActionHandler,j.CoreObject=b.CoreObject,j.NativeArray=b.NativeArray,j.Copyable=b.Copyable,j.MutableEnumerable=b.MutableEnumerable,j.MutableArray=b.MutableArray,j.TargetActionSupport=b.TargetActionSupport,j.Evented=b.Evented,j.PromiseProxyMixin=b.PromiseProxyMixin,j.Observable=b.Observable,j.typeOf=b.typeOf,j.isArray=b.isArray,j.Object=b.Object,j.onLoad=C.onLoad,j.runLoadHooks=C.runLoadHooks,j.Controller=f.default,j.ControllerMixin=p.default,j.Service=v.default,j._ProxyMixin=b._ProxyMixin,j.RSVP=b.RSVP,j.Namespace=b.Namespace,j._action=g.action,I.empty=y.empty,I.notEmpty=y.notEmpty,I.none=y.none,I.not=y.not,I.bool=y.bool,I.match=y.match,I.equal=y.equal,I.gt=y.gt,I.gte=y.gte,I.lt=y.lt,I.lte=y.lte,I.oneWay=y.oneWay,I.reads=y.oneWay,I.readOnly=y.readOnly,I.deprecatingAlias=y.deprecatingAlias,I.and=y.and,I.or=y.or,I.sum=y.sum,I.min=y.min,I.max=y.max,I.map=y.map,I.sort=y.sort,I.setDiff=y.setDiff,I.mapBy=y.mapBy,I.filter=y.filter,I.filterBy=y.filterBy,I.uniq=y.uniq,I.uniqBy=y.uniqBy,I.union=y.union,I.intersect=y.intersect,I.collect=y.collect,Object.defineProperty(j,"STRINGS",{configurable:!1,get:m._getStrings,set:m._setStrings}),Object.defineProperty(j,"BOOTED",{configurable:!1,enumerable:!1,get:u.isNamespaceSearchDisabled,set:u.setNamespaceSearchDisabled}),j.Component=_.Component,_.Helper.helper=_.helper,j.Helper=_.Helper,j.Checkbox=_.Checkbox,j.TextField=_.TextField,j.TextArea=_.TextArea,j.LinkComponent=_.LinkComponent,j._setComponentManager=_.setComponentManager,j._componentManagerCapabilities=_.capabilities,j._setModifierManager=_.setModifierManager,j._modifierManagerCapabilties=_.modifierCapabilties,j.Handlebars={template:_.template,Utils:{escapeExpression:_.escapeExpression}},j.HTMLBars={template:_.template},n.ENV.EXTEND_PROTOTYPES.String&&(String.prototype.htmlSafe=function(){return(0,_.htmlSafe)(this)}),j.String.htmlSafe=_.htmlSafe,j.String.isHTMLSafe=_.isHTMLSafe,Object.defineProperty(j,"TEMPLATES",{get:_.getTemplates,set:_.setTemplates,configurable:!1,enumerable:!1}),j.VERSION=E.default,L.JQUERY_INTEGRATION&&!w.jQueryDisabled&&Object.defineProperty(j,"$",{get:function(){return w.jQuery},configurable:!0,enumerable:!0}),j.ViewUtils={isSimpleClick:w.isSimpleClick,getElementView:w.getElementView,getViewElement:w.getViewElement,getViewBounds:w.getViewBounds,getViewClientRects:w.getViewClientRects,getViewBoundingClientRect:w.getViewBoundingClientRect,getRootViews:w.getRootViews,getChildViews:w.getChildViews,isSerializationFirstNode:_.isSerializationFirstNode},j.TextSupport=w.TextSupport,j.ComponentLookup=w.ComponentLookup,j.EventDispatcher=w.EventDispatcher,j.Location=R.Location,j.AutoLocation=R.AutoLocation,j.HashLocation=R.HashLocation,j.HistoryLocation=R.HistoryLocation,j.NoneLocation=R.NoneLocation,j.controllerFor=R.controllerFor,j.generateControllerFactory=R.generateControllerFactory,j.generateController=R.generateController,j.RouterDSL=R.RouterDSL,j.Router=R.Router,j.Route=R.Route,(0,C.runLoadHooks)("Ember.Application",C.default),j.DataAdapter=A.DataAdapter,j.ContainerDebugAdapter=A.ContainerDebugAdapter,(0,t.has)("ember-template-compiler")&&(0,t.default)("ember-template-compiler"),(0,t.has)("ember-testing")){var F=(0,t.default)("ember-testing")
j.Test=F.Test,j.Test.Adapter=F.Adapter,j.Test.QUnitAdapter=F.QUnitAdapter,j.setupForTesting=F.setupForTesting}(0,C.runLoadHooks)("Ember")
var z=j
...
T.prototype.add=function(e,t){for(var n,r=this.rootState,i="^",o=[0,0,0],a=new Array(e.length),s=[],u=!0,l=0,c=0;c<e.length;c++){for(var h=e[c],d=E(s,h.path,o),f=d.names,p=d.shouldDecodes;l<s.length;l++){var m=s[l]
4!==m.type&&(u=!1,r=r.put(47,!1,!1),i+="/",r=v[m.type](m,r),i+=g[m.type](m))}a[c]={handler:h.handler,names:f,shouldDecodes:p}}u&&(r=r.put(47,!1,!1),i+="/"),r.handlers=a,r.pattern=i+"$",r.types=o,"object"==typeof t&&null!==t&&t.as&&(n=t.as),n&&(this.names[n]={segments:s,handlers:a})},T.prototype.handlersFor=function(e){var t=this.names[e]
...
t.push(u)}else a+="="+encodeURIComponent(o),t.push(a)}}return 0===t.length?"":"?"+t.join("&")},T.prototype.parseQueryString=function(e){for(var t=e.split("&"),n={},r=0;r<t.length;r++){var i=t[r].split("="),o=x(i[0]),a=o.length,s=!1,u=void 0
1===i.length?u="true":(a>2&&"[]"===o.slice(a-2)&&(s=!0,n[o=o.slice(0,a-2)]||(n[o]=[])),u=i[1]?x(i[1]):""),s?n[o].push(u):n[o]=u}return n},T.prototype.recognize=function(e){var t,n=[this.rootState],r={},i=!1,o=e.indexOf("#");-1!==o&&(e=e.substr(0,o))
var a=e.indexOf("?")
...
for(var h=0;h<e.length&&(n=S(n,e.charCodeAt(h))).length;h++);for(var d=[],f=0;f<n.length;f++)n[f].handlers&&d.push(n[f])
...
var m=c[p],v=o&&o[a++]
d===b&&(d={}),T.ENCODE_AND_DECODE_PATH_SEGMENTS&&h[p]?d[m]=v&&decodeURIComponent(v):d[m]=v}s[u]={handler:l.handler,params:d,isDynamic:f}}return s}(p,l,r)),t},T.VERSION="0.3.4",T.ENCODE_AND_DECODE_PATH_SEGMENTS=!0,T.Normalizer={normalizeSegment:l,normalizePath:s,encodePathSegment:h},T.prototype.map=function(e,t){var n=new i
...
if(R.has(i)&&r){var h=R.get(i),d=S(h=function(e,n){var r={get metadata(){return k(e)}}
...
for(var o=0;e.length>o;o++)if(r=R.get(e[o]),t.call(n,r,o,i))return r},get name(){return a},get paramNames(){return u},get metadata(){return k(c)},get parent(){var t=e[o-1]
...
return r&&(f=S(f,l)),R.set(i,f),f})}function S(e,n){var r={get attributes(){return n}}
return Object.isFrozen(e)||e.hasOwnProperty("attributes")?Object.freeze((0,t.assign)({},e,r)):(0,t.assign)(e,r)}function k(e){return null!=e&&void 0!==e.buildRouteInfoMetadata?e.buildRouteInfoMetadata():null}var x=function(){function e(e,t,n,r){this._routePromise=void 0,this._route=null,this.params={},this.isResolved=!1,this.name=t,this.paramNames=n,this.router=e,r&&this._processRoute(r)}var t=e.prototype
...
var o=R.get(this),a=new T(this.router,this.name,this.paramNames,r,this.route,n)
...
return n.deserialize?i=n.deserialize(t,e):n.model&&(i=n.model(t,e)),i&&w(i)&&(i=void 0),r.Promise.resolve(i)},t}(x),O=function(e){function t(t,n,r,i){var o
...
i[u]=a[u]}}return new C(this.router,e,t,i)},t}(M),L=function(){function e(t){var n=Error.call(this,t)
...
t=new N(this,a[a.length-1].name,void 0,[],o)}else"/"===e.charAt(0)?(h(this,"Attempting URL transition to "+e),t=new j(this,e)):(h(this,"Attempting transition to "+e),t=new N(this,e,void 0,n,o))
...
var d=I(new N(this,s,void 0,t).applyToHandlers(h,l,s,!0,!0).routeInfos,h.routeInfos)
if(!n||!d)return d
var f={}
u(f,n)
var m=o.queryParams
...
return t||(t=e._promiseCallbacks={}),t}e.asap=ne,e.all=I,e.allSettled=z,e.race=B,e.hash=U,e.hashSettled=V,e.rethrow=W,e.defer=Y,e.denodeify=N,e.configure=a,e.on=_e,e.off=Ee,e.resolve=$,e.reject=Q,e.map=G,e.filter=Z,e.async=e.EventTarget=e.Promise=e.cast=e.default=void 0
...
return h=null,e.apply(this,arguments)}catch(t){return m.error=t,m}}function y(e){return h=e,g}function b(e,t,n){if(t.constructor===e.constructor&&n===x&&e.constructor.resolve===l)(function(e,t){t._state===f?w(e,t._result):t._state===p?(t._onError=null,R(e,t._result)):A(t,void 0,function(n){t===n?w(e,n):_(e,n)},function(t){return R(e,t)})})(e,t)
...
e===t?w(e,t):(r=typeof(n=t),null===n||"object"!==r&&"function"!==r?w(e,t):b(e,t,v(t)))}function E(e){e._onError&&e._onError(e._result),S(e)}function w(e,t){e._state===d&&(e._result=t,e._state=f,0===e._subscribers.length?o.instrument&&u("fulfilled",e):o.async(S,e))}function R(e,t){e._state===d&&(e._state=p,e._result=t,o.async(E,e))}function A(e,t,n,r){var i=e._subscribers,a=i.length
e._onError=null,i[a]=t,i[a+f]=n,i[a+p]=r,0===a&&e._state&&o.async(S,e)}function S(e){var t=e._subscribers,n=e._state
if(o.instrument&&u(n===f?"fulfilled":"rejected",e),0!==t.length){for(var r,i,a=e._result,s=0;s<t.length;s+=3)r=t[s],i=t[s+n],r?k(n,r,i,a):i(a)
...
m.error=null,R(t,a)}else o?_(t,i):e===f?w(t,i):e===p&&R(t,i)}function x(e,t,n){var r=this._state
if(r===f&&!e||r===p&&!t)return o.instrument&&u("chained",this,this),this
this._onError=null
var i=new this.constructor(c,n),a=this._result
if(o.instrument&&u("chained",this,i),r===d)A(this,i,e,t)
else{var s=r===f?e:t
o.async(function(){return k(r,i,s,a)})}return i}var T=function(){function e(e,t,n,r){this._instanceConstructor=e,this.promise=new e(c,r),this._abortOnReject=n,this._isUsingOwnPromise=e===P,this._isUsingOwnResolve=e.resolve===l,this._init.apply(this,arguments)}var t=e.prototype
...
if(i===x&&e._state!==d)e._onError=null,this._settledAt(e._state,t,e._result,n)
...
A(e,void 0,function(e){return r._settledAt(f,t,e,n)},function(e){return r._settledAt(p,t,e,n)})},e}()
function C(e,t,n){this._remaining--,this._result[t]=e===f?{state:"fulfilled",value:n}:{state:"rejected",reason:n}}var O="rsvp_"+Date.now()+"-",M=0
...
return n}(arguments,t)):_(l,n)},i?function(e,t,n,r){return P.all(t).then(function(t){return L(e,t,n,r)})}(l,r,e,this):L(l,r,e,this)}
return n.__proto__=e,n}function L(e,t,n,r){if(y(n).apply(r,t)===m){var i=m.error
m.error=null,R(e,i)}return e}function j(e){return null!==e&&"object"==typeof e&&(e.constructor===P||v(e))}function I(e,t){return P.all(e,t)}e.Promise=P,P.cast=l,P.all=function(e,t){return Array.isArray(e)?new T(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},P.race=function(e,t){var n=new this(c,t)
if(!Array.isArray(e))return R(n,new TypeError("Promise.race must be called with an array")),n
for(var r=0;n._state===d&&r<e.length;r++)A(this.resolve(e[r]),void 0,function(e){return _(n,e)},function(e){return R(n,e)})
return n},P.resolve=l,P.reject=function(e,t){var n=new this(c,t)
return R(n,e),n},P.prototype._guidKey=O,P.prototype.then=x
...
return new q(P,e,t).promise})}var H=function(e){function t(t,n,r){return e.call(this,t,n,!1,r)||this}return(0,n.inheritsLoose)(t,e),t}(q)
...
function G(e,t,n){return"function"!=typeof t?P.reject(new TypeError("map expects a function as a second argument"),n):P.resolve(e,n).then(function(e){if(!Array.isArray(e))throw new TypeError("map must be called with an array")
return new K(P,e,t,n).promise})}function $(e,t){return P.resolve(e,t)}function Q(e,t){return P.reject(e,t)}var X={},J=function(e){function t(){return e.apply(this,arguments)||this}(0,n.inheritsLoose)(t,e)
var r=t.prototype
...
i===m?this._settledAt(p,t,i.error,!1):this._eachEntry(i,t,!1)}else this._remaining--,n||(this._result[t]=X)},t}(K)
...
for(var Re in a("instrument",!0),we)we.hasOwnProperty(Re)&&_e(Re,we[Re])}var Ae={asap:ne,cast:ye,Promise:P,EventTarget:i,all:I,allSettled:z,race:B,hash:U,hashSettled:V,rethrow:W,defer:Y,denodeify:N,configure:a,on:_e,off:Ee,resolve:$,reject:Q,map:G,async:be,filter:Z}
e.default=Ae}),t("ember")}(),function(){if("undefined"==typeof FastBoot){var e=document.getElementById("fastboot-body-start")
...
return{default:self.jQuery,__esModule:!0}})}(),Ember.Component.reopen({$:function(e){if(this.element)return e?jQuery(e,this.element):jQuery(this.element)}}),"undefined"==typeof FastBoot&&function(e,t){"function"==typeof define&&define.amd?define(function(){return e.Reveal=t(),e.Reveal}):"object"==typeof exports?module.exports=t():e.Reveal=t()}(this,function(){"use strict"
var e,t,n,r,i,o,a,s,u,l=".slides section",c=".slides>section",h=".slides>section.present>section",d=".slides>section:first-of-type",f=navigator.userAgent,p={width:960,height:700,margin:.04,minScale:.2,maxScale:2,controls:!0,controlsTutorial:!0,controlsLayout:"bottom-right",controlsBackArrows:"faded",progress:!0,slideNumber:!1,showSlideNumber:"all",hashOneBasedIndex:!1,hash:!1,history:!1,keyboard:!0,keyboardCondition:null,overview:!0,disableLayout:!1,center:!0,touch:!0,loop:!1,rtl:!1,navigationMode:"default",shuffle:!1,fragments:!0,fragmentInURL:!1,embedded:!1,help:!0,pause:!0,showNotes:!1,autoPlayMedia:null,preloadIframes:null,autoSlide:0,autoSlideStoppable:!0,autoSlideMethod:null,defaultTiming:null,mouseWheel:!1,rollingLinks:!1,hideAddressBar:!0,previewLinks:!1,postMessage:!0,postMessageEvents:!1,focusBodyOnPageVisibilityChange:!0,transition:"slide",transitionSpeed:"default",backgroundTransition:"fade",parallaxBackgroundImage:"",parallaxBackgroundSize:"",parallaxBackgroundRepeat:"",parallaxBackgroundPosition:"",parallaxBackgroundHorizontal:null,parallaxBackgroundVertical:null,pdfMaxPagesPerSlide:Number.POSITIVE_INFINITY,pdfSeparateFragments:!0,pdfPageHeightOffset:-1,viewDistance:3,display:"block",hideInactiveCursor:!0,hideCursorTime:5e3,dependencies:[]},m=!1,v=!1,g=!1,y=null,b=null,_=!1,E=!1,w=[],R=1,A={layout:"",overview:""},S={},k={},x=[],T={},C=0,O=0,M=!1,P=0,D=!1,N=0,L=0,j=-1,I=!1,F={startX:0,startY:0,startCount:0,captured:!1,threshold:40},z={},B={}
function q(){var e=Object.keys(k).length
if(0===e)U()
else{var t=function(){0==--e&&U()}
for(var n in k){var r=k[n]
if("function"==typeof r.init){var i=r.init()
i&&"function"==typeof i.then?i.then(t):t()}else t()}}}function U(){var r
x.length&&x.forEach(function(e){H(e.src,e.callback)}),v=!0,S.slides.classList.add("no-transition"),a?S.wrapper.classList.add("no-hover"):S.wrapper.classList.remove("no-hover"),/iphone/gi.test(f)?S.wrapper.classList.add("ua-iphone"):S.wrapper.classList.remove("ua-iphone"),S.background=Y(S.wrapper,"div","backgrounds",null),S.progress=Y(S.wrapper,"div","progress","<span></span>"),S.progressbar=S.progress.querySelector("span"),S.controls=Y(S.wrapper,"aside","controls",'<button class="navigate-left" aria-label="previous slide"><div class="controls-arrow"></div></button><button class="navigate-right" aria-label="next slide"><div class="controls-arrow"></div></button><button class="navigate-up" aria-label="above slide"><div class="controls-arrow"></div></button><button class="navigate-down" aria-label="below slide"><div class="controls-arrow"></div></button>'),S.slideNumber=Y(S.wrapper,"div","slide-number",""),S.speakerNotes=Y(S.wrapper,"div","speaker-notes",null),S.speakerNotes.setAttribute("data-prevent-swipe",""),S.speakerNotes.setAttribute("tabindex","0"),S.pauseOverlay=Y(S.wrapper,"div","pause-overlay",p.controls?'<button class="resume-button">Resume presentation</button>':null),S.wrapper.setAttribute("role","application"),S.controlsLeft=Z(document.querySelectorAll(".navigate-left")),S.controlsRight=Z(document.querySelectorAll(".navigate-right")),S.controlsUp=Z(document.querySelectorAll(".navigate-up")),S.controlsDown=Z(document.querySelectorAll(".navigate-down")),S.controlsPrev=Z(document.querySelectorAll(".navigate-prev")),S.controlsNext=Z(document.querySelectorAll(".navigate-next")),S.controlsRightArrow=S.controls.querySelector(".navigate-right"),S.controlsDownArrow=S.controls.querySelector(".navigate-down"),S.statusDiv=((r=document.getElementById("aria-status-div"))||((r=document.createElement("div")).style.position="absolute",r.style.height="1px",r.style.width="1px",r.style.overflow="hidden",r.style.clip="rect( 1px, 1px, 1px, 1px )",r.setAttribute("id","aria-status-div"),r.setAttribute("aria-live","polite"),r.setAttribute("aria-atomic","true"),S.wrapper.appendChild(r)),r),p.postMessage&&window.addEventListener("message",function(t){var n=t.data
"string"==typeof n&&"{"===n.charAt(0)&&"}"===n.charAt(n.length-1)&&(n=JSON.parse(n)).method&&"function"==typeof e[n.method]&&e[n.method].apply(e,n.args)},!1),setInterval(function(){0===S.wrapper.scrollTop&&0===S.wrapper.scrollLeft||(S.wrapper.scrollTop=0,S.wrapper.scrollLeft=0)},1e3),Z(S.wrapper.querySelectorAll(c)).forEach(function(e){var t=Z(e.querySelectorAll("section"))
t.forEach(function(e,t){t>0&&(e.classList.remove("present"),e.classList.remove("past"),e.classList.add("future"),e.setAttribute("aria-hidden","true"))})}),$(),it(),We(!0),setTimeout(function(){S.slides.classList.remove("no-transition"),S.wrapper.classList.add("ready"),ue("ready",{indexh:t,indexv:n,currentSlide:i})},1),ae()&&(X(),"complete"===document.readyState?W():window.addEventListener("load",W))}function H(e,t){var n=document.createElement("script")
n.type="text/javascript",n.async=!1,n.defer=!1,n.src=e,t&&(n.onload=n.onreadystatechange=function(e){("load"===e.type||/loaded|complete/.test(n.readyState))&&(n.onload=n.onreadystatechange=n.onerror=null,t())},n.onerror=function(e){n.onload=n.onreadystatechange=n.onerror=null,t(new Error("Failed loading script: "+n.src+"\n"+e))})
var r=document.querySelector("head")
r.insertBefore(n,r.lastChild)}function V(e){var t=""
if(3===e.nodeType)t+=e.textContent
else if(1===e.nodeType){var n=e.getAttribute("aria-hidden"),r="none"===window.getComputedStyle(e).display
"true"===n||r||Z(e.childNodes).forEach(function(e){t+=V(e)})}return t}function W(){var e=ve(window.innerWidth,window.innerHeight),t=Math.floor(e.width*(1+p.margin)),n=Math.floor(e.height*(1+p.margin)),r=e.width,i=e.height
re("@page{size:"+t+"px "+n+"px; margin: 0px;}"),re(".reveal section>img, .reveal section>video, .reveal section>iframe{max-width: "+r+"px; max-height:"+i+"px}"),document.body.classList.add("print-pdf"),document.body.style.width=t+"px",document.body.style.height=n+"px",me(r,i),Z(S.wrapper.querySelectorAll(c)).forEach(function(e,t){e.setAttribute("data-index-h",t),e.classList.contains("stack")&&Z(e.querySelectorAll("section")).forEach(function(e,n){e.setAttribute("data-index-h",t),e.setAttribute("data-index-v",n)})}),Z(S.wrapper.querySelectorAll(l)).forEach(function(e){if(!1===e.classList.contains("stack")){var o=(t-r)/2,a=(n-i)/2,s=e.scrollHeight,u=Math.max(Math.ceil(s/n),1);(1===(u=Math.min(u,p.pdfMaxPagesPerSlide))&&p.center||e.classList.contains("center"))&&(a=Math.max((n-s)/2,0))
var l=document.createElement("div")
if(l.className="pdf-page",l.style.height=(n+p.pdfPageHeightOffset)*u+"px",e.parentNode.insertBefore(l,e),l.appendChild(e),e.style.left=o+"px",e.style.top=a+"px",e.style.width=r+"px",e.slideBackgroundElement&&l.insertBefore(e.slideBackgroundElement,e),p.showNotes){var c=ht(e)
if(c){var h="string"==typeof p.showNotes?p.showNotes:"inline",d=document.createElement("div")
d.classList.add("speaker-notes"),d.classList.add("speaker-notes-pdf"),d.setAttribute("data-layout",h),d.innerHTML=c,"separate-page"===h?l.parentNode.insertBefore(d,l.nextSibling):(d.style.left="8px",d.style.bottom="8px",d.style.width=t-16+"px",l.appendChild(d))}}if(p.slideNumber&&/all|print/i.test(p.showSlideNumber)){var f=parseInt(e.getAttribute("data-index-h"),10)+1,m=parseInt(e.getAttribute("data-index-v"),10)+1,v=document.createElement("div")
v.classList.add("slide-number"),v.classList.add("slide-number-pdf"),v.innerHTML=He(f,".",m),l.appendChild(v)}if(p.pdfSeparateFragments){var g,y,b=ft(l.querySelectorAll(".fragment"),!0)
b.forEach(function(e){g&&g.forEach(function(e){e.classList.remove("current-fragment")}),e.forEach(function(e){e.classList.add("visible","current-fragment")})
var t=l.cloneNode(!0)
l.parentNode.insertBefore(t,(y||l).nextSibling),g=e,y=t}),b.forEach(function(e){e.forEach(function(e){e.classList.remove("visible","current-fragment")})})}else Z(l.querySelectorAll(".fragment:not(.fade-out)")).forEach(function(e){e.classList.add("visible")})}}),ue("pdf-ready")}function Y(e,t,n,r){for(var i=e.querySelectorAll("."+n),o=0;o<i.length;o++){var a=i[o]
if(a.parentNode===e)return a}var s=document.createElement(t)
return s.className=n,"string"==typeof r&&(s.innerHTML=r),e.appendChild(s),s}function K(e,t){var n=document.createElement("div")
n.className="slide-background "+e.className.replace(/present|past|future/,"")
var r=document.createElement("div")
return r.className="slide-background-content",n.appendChild(r),t.appendChild(n),e.slideBackgroundElement=n,e.slideBackgroundContentElement=r,G(e),n}function G(e){var t=e.slideBackgroundElement,n=e.slideBackgroundContentElement
e.classList.remove("has-dark-background"),e.classList.remove("has-light-background"),t.removeAttribute("data-loaded"),t.removeAttribute("data-background-hash"),t.removeAttribute("data-background-size"),t.removeAttribute("data-background-transition"),t.style.backgroundColor="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundPosition="",n.style.backgroundImage="",n.style.opacity="",n.innerHTML=""
var r={background:e.getAttribute("data-background"),backgroundSize:e.getAttribute("data-background-size"),backgroundImage:e.getAttribute("data-background-image"),backgroundVideo:e.getAttribute("data-background-video"),backgroundIframe:e.getAttribute("data-background-iframe"),backgroundColor:e.getAttribute("data-background-color"),backgroundRepeat:e.getAttribute("data-background-repeat"),backgroundPosition:e.getAttribute("data-background-position"),backgroundTransition:e.getAttribute("data-background-transition"),backgroundOpacity:e.getAttribute("data-background-opacity")}
r.background&&(/^(http|file|\/\/)/gi.test(r.background)||/\.(svg|png|jpg|jpeg|gif|bmp)([?#\s]|$)/gi.test(r.background)?e.setAttribute("data-background-image",r.background):t.style.background=r.background),(r.background||r.backgroundColor||r.backgroundImage||r.backgroundVideo||r.backgroundIframe)&&t.setAttribute("data-background-hash",r.background+r.backgroundSize+r.backgroundImage+r.backgroundVideo+r.backgroundIframe+r.backgroundColor+r.backgroundRepeat+r.backgroundPosition+r.backgroundTransition+r.backgroundOpacity),r.backgroundSize&&t.setAttribute("data-background-size",r.backgroundSize),r.backgroundColor&&(t.style.backgroundColor=r.backgroundColor),r.backgroundTransition&&t.setAttribute("data-background-transition",r.backgroundTransition),r.backgroundSize&&(n.style.backgroundSize=r.backgroundSize),r.backgroundRepeat&&(n.style.backgroundRepeat=r.backgroundRepeat),r.backgroundPosition&&(n.style.backgroundPosition=r.backgroundPosition),r.backgroundOpacity&&(n.style.opacity=r.backgroundOpacity)
var i=r.backgroundColor
if(!i){var o=window.getComputedStyle(t)
o&&o.backgroundColor&&(i=o.backgroundColor)}if(i){var a=oe(i)
a&&0!==a.a&&(function(e){"string"==typeof e&&(e=oe(e))
if(e)return(299*e.r+587*e.g+114*e.b)/1e3
return null}(i)<128?e.classList.add("has-dark-background"):e.classList.add("has-light-background"))}}function $(e){var t=p.transition
if("object"==typeof e&&J(p,e),!1!==v){var n=S.wrapper.querySelectorAll(l).length
S.wrapper.classList.remove(t),!1===T.transforms3d&&(p.transition="linear"),S.wrapper.classList.add(p.transition),S.wrapper.setAttribute("data-transition-speed",p.transitionSpeed),S.wrapper.setAttribute("data-background-transition",p.backgroundTransition),S.controls.style.display=p.controls?"block":"none",S.progress.style.display=p.progress?"block":"none",S.controls.setAttribute("data-controls-layout",p.controlsLayout),S.controls.setAttribute("data-controls-back-arrows",p.controlsBackArrows),p.shuffle&&Ie(),p.rtl?S.wrapper.classList.add("rtl"):S.wrapper.classList.remove("rtl"),p.center?S.wrapper.classList.add("center"):S.wrapper.classList.remove("center"),!1===p.pause&&Oe(),p.showNotes&&S.speakerNotes.setAttribute("data-layout","string"==typeof p.showNotes?p.showNotes:"inline"),p.mouseWheel?(document.addEventListener("DOMMouseScroll",zt,!1),document.addEventListener("mousewheel",zt,!1)):(document.removeEventListener("DOMMouseScroll",zt,!1),document.removeEventListener("mousewheel",zt,!1)),p.rollingLinks?function(){if(T.transforms3d&&!("msPerspective"in document.body.style))for(var e=S.wrapper.querySelectorAll(l+" a"),t=0,n=e.length;t<n;t++){var r=e[t]
if(r.textContent&&!r.querySelector("*")&&(!r.className||!r.classList.contains(r,"roll"))){var i=document.createElement("span")
i.setAttribute("data-title",r.text),i.innerHTML=r.innerHTML,r.classList.add("roll"),r.innerHTML="",r.appendChild(i)}}}():function(){for(var e=S.wrapper.querySelectorAll(l+" a.roll"),t=0,n=e.length;t<n;t++){var r=e[t],i=r.querySelector("span")
i&&(r.classList.remove("roll"),r.innerHTML=i.innerHTML)}}(),p.hideInactiveCursor?(document.addEventListener("mousemove",Ot,!1),document.addEventListener("mousedown",Ot,!1)):(xe(),document.removeEventListener("mousemove",Ot,!1),document.removeEventListener("mousedown",Ot,!1)),p.previewLinks?(le(),ce("[data-preview-link=false]")):(ce(),le("[data-preview-link]:not([data-preview-link=false])")),u&&(u.destroy(),u=null),n>1&&p.autoSlide&&p.autoSlideStoppable&&T.canvas&&T.requestAnimationFrame&&((u=new Zt(S.wrapper,function(){return Math.min(Math.max((Date.now()-j)/N,0),1)})).on("click",Jt),I=!1),!1===p.fragments&&Z(S.slides.querySelectorAll(".fragment")).forEach(function(e){e.classList.add("visible"),e.classList.remove("current-fragment")})
var r="none"
p.slideNumber&&!ae()&&("all"===p.showSlideNumber?r="block":"speaker"===p.showSlideNumber&&rt()&&(r="block")),S.slideNumber.style.display=r,"default"!==p.navigationMode?S.wrapper.setAttribute("data-navigation-mode",p.navigationMode):S.wrapper.removeAttribute("data-navigation-mode"),"linear"===p.navigationMode?(z["&#8594;  ,  &#8595;  ,  SPACE  ,  N  ,  L  ,  J"]="Next slide",z["&#8592;  ,  &#8593;  ,  P  ,  H  ,  K"]="Previous slide"):(z["N  ,  SPACE"]="Next slide",z.P="Previous slide",z["&#8592;  ,  H"]="Navigate left",z["&#8594;  ,  L"]="Navigate right",z["&#8593;  ,  K"]="Navigate up",z["&#8595;  ,  J"]="Navigate down"),z["Home  ,  &#8984;/CTRL &#8592;"]="First slide",z["End  ,  &#8984;/CTRL &#8594;"]="Last slide",z["B  ,  ."]="Pause",z.F="Fullscreen",z["ESC, O"]="Slide overview",Le()}}function Q(){var e;(D=!0,window.addEventListener("hashchange",Kt,!1),window.addEventListener("resize",Gt,!1),p.touch&&("onpointerdown"in window?(S.wrapper.addEventListener("pointerdown",jt,!1),S.wrapper.addEventListener("pointermove",It,!1),S.wrapper.addEventListener("pointerup",Ft,!1)):window.navigator.msPointerEnabled?(S.wrapper.addEventListener("MSPointerDown",jt,!1),S.wrapper.addEventListener("MSPointerMove",It,!1),S.wrapper.addEventListener("MSPointerUp",Ft,!1)):(S.wrapper.addEventListener("touchstart",Dt,!1),S.wrapper.addEventListener("touchmove",Nt,!1),S.wrapper.addEventListener("touchend",Lt,!1))),p.keyboard&&(document.addEventListener("keydown",Pt,!1),document.addEventListener("keypress",Mt,!1)),p.progress&&S.progress&&S.progress.addEventListener("click",Bt,!1),S.pauseOverlay.addEventListener("click",Oe,!1),p.focusBodyOnPageVisibilityChange)&&("hidden"in document?e="visibilitychange":"msHidden"in document?e="msvisibilitychange":"webkitHidden"in document&&(e="webkitvisibilitychange"),e&&document.addEventListener(e,$t,!1))
var t=["touchstart","click"]
f.match(/android/gi)&&(t=["touchstart"]),t.forEach(function(e){S.controlsLeft.forEach(function(t){t.addEventListener(e,qt,!1)}),S.controlsRight.forEach(function(t){t.addEventListener(e,Ut,!1)}),S.controlsUp.forEach(function(t){t.addEventListener(e,Ht,!1)}),S.controlsDown.forEach(function(t){t.addEventListener(e,Vt,!1)}),S.controlsPrev.forEach(function(t){t.addEventListener(e,Wt,!1)}),S.controlsNext.forEach(function(t){t.addEventListener(e,Yt,!1)})})}function X(){D=!1,document.removeEventListener("keydown",Pt,!1),document.removeEventListener("keypress",Mt,!1),window.removeEventListener("hashchange",Kt,!1),window.removeEventListener("resize",Gt,!1),S.wrapper.removeEventListener("pointerdown",jt,!1),S.wrapper.removeEventListener("pointermove",It,!1),S.wrapper.removeEventListener("pointerup",Ft,!1),S.wrapper.removeEventListener("MSPointerDown",jt,!1),S.wrapper.removeEventListener("MSPointerMove",It,!1),S.wrapper.removeEventListener("MSPointerUp",Ft,!1),S.wrapper.removeEventListener("touchstart",Dt,!1),S.wrapper.removeEventListener("touchmove",Nt,!1),S.wrapper.removeEventListener("touchend",Lt,!1),S.pauseOverlay.removeEventListener("click",Oe,!1),p.progress&&S.progress&&S.progress.removeEventListener("click",Bt,!1),["touchstart","click"].forEach(function(e){S.controlsLeft.forEach(function(t){t.removeEventListener(e,qt,!1)}),S.controlsRight.forEach(function(t){t.removeEventListener(e,Ut,!1)}),S.controlsUp.forEach(function(t){t.removeEventListener(e,Ht,!1)}),S.controlsDown.forEach(function(t){t.removeEventListener(e,Vt,!1)}),S.controlsPrev.forEach(function(t){t.removeEventListener(e,Wt,!1)}),S.controlsNext.forEach(function(t){t.removeEventListener(e,Yt,!1)})})}function J(e,t){for(var n in t)e[n]=t[n]
return e}function Z(e){return Array.prototype.slice.call(e)}function ee(e){if("string"==typeof e){if("null"===e)return null
if("true"===e)return!0
if("false"===e)return!1
if(e.match(/^-?[\d\.]+$/))return parseFloat(e)}return e}function te(e,t){e.style.WebkitTransform=t,e.style.MozTransform=t,e.style.msTransform=t,e.style.transform=t}function ne(e){"string"==typeof e.layout&&(A.layout=e.layout),"string"==typeof e.overview&&(A.overview=e.overview),A.layout?te(S.slides,A.layout+" "+A.overview):te(S.slides,A.overview)}function re(e){var t=document.createElement("style")
t.type="text/css",t.styleSheet?t.styleSheet.cssText=e:t.appendChild(document.createTextNode(e)),document.getElementsByTagName("head")[0].appendChild(t)}function ie(e,t){for(var n=e.parentNode;n;){var r=n.matches||n.matchesSelector||n.msMatchesSelector
if(r&&r.call(n,t))return n
n=n.parentNode}return null}function oe(e){var t=e.match(/^#([0-9a-f]{3})$/i)
...
if(n&&n[1])return n=n[1],{r:parseInt(n.substr(0,2),16),g:parseInt(n.substr(2,2),16),b:parseInt(n.substr(4,2),16)}
var r=e.match(/^rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)$/i)
if(r)return{r:parseInt(r[1],10),g:parseInt(r[2],10),b:parseInt(r[3],10)}
var i=e.match(/^rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\,\s*([\d]+|[\d]*.[\d]+)\s*\)$/i)
return i?{r:parseInt(i[1],10),g:parseInt(i[2],10),b:parseInt(i[3],10),a:parseFloat(i[4])}:null}function ae(){return/print-pdf/gi.test(window.location.search)}function se(){setTimeout(function(){window.scrollTo(0,1)},10)}function ue(e,t){var n=document.createEvent("HTMLEvents",1,2)
n.initEvent(e,!0,!0),J(n,t),S.wrapper.dispatchEvent(n),p.postMessageEvents&&window.parent!==window.self&&window.parent.postMessage(JSON.stringify({namespace:"reveal",eventName:e,state:dt()}),"*")}function le(e){Z(document.querySelectorAll(e||"a")).forEach(function(e){/^(http|www)/gi.test(e.getAttribute("href"))&&e.addEventListener("click",Xt,!1)})}function ce(e){Z(document.querySelectorAll(e||"a")).forEach(function(e){/^(http|www)/gi.test(e.getAttribute("href"))&&e.removeEventListener("click",Xt,!1)})}function he(e){"boolean"==typeof e?e?de():fe():S.overlay?fe():de()}function de(){if(p.help){fe(),S.overlay=document.createElement("div"),S.overlay.classList.add("overlay"),S.overlay.classList.add("overlay-help"),S.wrapper.appendChild(S.overlay)
var e='<p class="title">Keyboard Shortcuts</p><br/>'
for(var t in e+="<table><th>KEY</th><th>ACTION</th>",z)e+="<tr><td>"+t+"</td><td>"+z[t]+"</td></tr>"
for(var n in B)B[n].key&&B[n].description&&(e+="<tr><td>"+B[n].key+"</td><td>"+B[n].description+"</td></tr>")
e+="</table>",S.overlay.innerHTML=["<header>",'<a class="close" href="#"><span class="icon"></span></a>',"</header>",'<div class="viewport">','<div class="viewport-inner">'+e+"</div>","</div>"].join(""),S.overlay.querySelector(".close").addEventListener("click",function(e){fe(),e.preventDefault()},!1),setTimeout(function(){S.overlay.classList.add("visible")},1)}}function fe(){S.overlay&&(S.overlay.parentNode.removeChild(S.overlay),S.overlay=null)}function pe(){if(S.wrapper&&!ae()){if(!p.disableLayout){a&&document.documentElement.style.setProperty("--vh",.01*window.innerHeight+"px")
var e=ve(),t=R
me(p.width,p.height),S.slides.style.width=e.width+"px",S.slides.style.height=e.height+"px",R=Math.min(e.presentationWidth/e.width,e.presentationHeight/e.height),R=Math.max(R,p.minScale),1===(R=Math.min(R,p.maxScale))?(S.slides.style.zoom="",S.slides.style.left="",S.slides.style.top="",S.slides.style.bottom="",S.slides.style.right="",ne({layout:""})):R>1&&T.zoom?(S.slides.style.zoom=R,S.slides.style.left="",S.slides.style.top="",S.slides.style.bottom="",S.slides.style.right="",ne({layout:""})):(S.slides.style.zoom="",S.slides.style.left="50%",S.slides.style.top="50%",S.slides.style.bottom="auto",S.slides.style.right="auto",ne({layout:"translate(-50%, -50%) scale("+R+")"}))
for(var n=Z(S.wrapper.querySelectorAll(l)),r=0,i=n.length;r<i;r++){var o=n[r]
"none"!==o.style.display&&(p.center||o.classList.contains("center")?o.classList.contains("stack")?o.style.top=0:o.style.top=Math.max((e.height-o.scrollHeight)/2,0)+"px":o.style.top="")}t!==R&&ue("resize",{oldScale:t,scale:R,size:e})}qe(),Ye(),Ae()&&Ee()}}function me(e,t){Z(S.slides.querySelectorAll("section > .stretch")).forEach(function(n){var r=function(e,t){if(t=t||0,e){var n,r=e.style.height
return e.style.height="0px",e.parentNode.style.height="auto",n=t-e.parentNode.offsetHeight,e.style.height=r+"px",e.parentNode.style.removeProperty("height"),n}return t}(n,t)
if(/(img|video)/gi.test(n.nodeName)){var i=n.naturalWidth||n.videoWidth,o=n.naturalHeight||n.videoHeight,a=Math.min(e/i,r/o)
n.style.width=i*a+"px",n.style.height=o*a+"px"}else n.style.width=e+"px",n.style.height=r+"px"})}function ve(e,t){var n={width:p.width,height:p.height,presentationWidth:e||S.wrapper.offsetWidth,presentationHeight:t||S.wrapper.offsetHeight}
return n.presentationWidth-=n.presentationWidth*p.margin,n.presentationHeight-=n.presentationHeight*p.margin,"string"==typeof n.width&&/%$/.test(n.width)&&(n.width=parseInt(n.width,10)/100*n.presentationWidth),"string"==typeof n.height&&/%$/.test(n.height)&&(n.height=parseInt(n.height,10)/100*n.presentationHeight),n}function ge(e,t){"object"==typeof e&&"function"==typeof e.setAttribute&&e.setAttribute("data-previous-indexv",t||0)}function ye(e){if("object"==typeof e&&"function"==typeof e.setAttribute&&e.classList.contains("stack")){var t=e.hasAttribute("data-start-indexv")?"data-start-indexv":"data-previous-indexv"
return parseInt(e.getAttribute(t)||0,10)}return 0}function be(){if(p.overview&&!Ae()){g=!0,S.wrapper.classList.add("overview"),S.wrapper.classList.remove("overview-deactivating"),T.overviewTransitions&&setTimeout(function(){S.wrapper.classList.add("overview-animated")},1),bt(),S.slides.appendChild(S.background),Z(S.wrapper.querySelectorAll(l)).forEach(function(e){e.classList.contains("stack")||e.addEventListener("click",Qt,!0)})
var e=ve()
y=e.width+70,b=e.height+70,p.rtl&&(y=-y),ze(),_e(),Ee(),pe(),ue("overviewshown",{indexh:t,indexv:n,currentSlide:i})}}function _e(){Z(S.wrapper.querySelectorAll(c)).forEach(function(e,t){e.setAttribute("data-index-h",t),te(e,"translate3d("+t*y+"px, 0, 0)"),e.classList.contains("stack")&&Z(e.querySelectorAll("section")).forEach(function(e,n){e.setAttribute("data-index-h",t),e.setAttribute("data-index-v",n),te(e,"translate3d(0, "+n*b+"px, 0)")})}),Z(S.background.childNodes).forEach(function(e,t){te(e,"translate3d("+t*y+"px, 0, 0)"),Z(e.querySelectorAll(".slide-background")).forEach(function(e,t){te(e,"translate3d(0, "+t*b+"px, 0)")})})}function Ee(){var e=Math.min(window.innerWidth,window.innerHeight)
ne({overview:["scale("+Math.max(e/5,150)/e+")","translateX("+-t*y+"px)","translateY("+-n*b+"px)"].join(" ")})}function we(){p.overview&&(g=!1,S.wrapper.classList.remove("overview"),S.wrapper.classList.remove("overview-animated"),S.wrapper.classList.add("overview-deactivating"),setTimeout(function(){S.wrapper.classList.remove("overview-deactivating")},1),S.wrapper.appendChild(S.background),Z(S.wrapper.querySelectorAll(l)).forEach(function(e){te(e,""),e.removeEventListener("click",Qt,!0)}),Z(S.background.querySelectorAll(".slide-background")).forEach(function(e){te(e,"")}),ne({overview:""}),Ne(t,n),pe(),yt(),ue("overviewhidden",{indexh:t,indexv:n,currentSlide:i}))}function Re(e){"boolean"==typeof e?e?be():we():Ae()?we():be()}function Ae(){return g}function Se(){var e,r="/",o=i?i.getAttribute("id"):null
if(o&&(o=encodeURIComponent(o)),p.fragmentInURL&&(e=at().f),"string"==typeof o&&o.length&&void 0===e)r="/"+o
else{var a=p.hashOneBasedIndex?1:0;(t>0||n>0||void 0!==e)&&(r+=t+a),(n>0||void 0!==e)&&(r+="/"+(n+a)),void 0!==e&&(r+="/"+e)}return r}function ke(e){return(e=e||i)&&e.parentNode&&!!e.parentNode.nodeName.match(/section/i)}function xe(){M&&(M=!1,S.wrapper.style.cursor="")}function Te(){!1===M&&(M=!0,S.wrapper.style.cursor="none")}function Ce(){if(p.pause){var e=S.wrapper.classList.contains("paused")
bt(),S.wrapper.classList.add("paused"),!1===e&&ue("paused")}}function Oe(){var e=S.wrapper.classList.contains("paused")
S.wrapper.classList.remove("paused"),yt(),e&&ue("resumed")}function Me(e){"boolean"==typeof e?e?Ce():Oe():Pe()?Oe():Ce()}function Pe(){return S.wrapper.classList.contains("paused")}function De(e){"boolean"==typeof e?e?Et():_t():I?Et():_t()}function Ne(e,o,a,s){r=i
var u=S.wrapper.querySelectorAll(c)
if(0!==u.length){void 0!==o||Ae()||(o=ye(u[e])),r&&r.parentNode&&r.parentNode.classList.contains("stack")&&ge(r.parentNode,n)
var l=w.concat()
w.length=0
var f=t||0,p=n||0
t=Fe(c,void 0===e?t:e),n=Fe(h,void 0===o?n:o),ze(),pe(),Ae()&&Ee()
var m=u[t],v=m.querySelectorAll("section")
i=v[n]||m,void 0!==a&&mt(a)
var g=t!==f||n!==p
g||(r=null),r&&r!==i&&(r.classList.remove("present"),r.setAttribute("aria-hidden","true"),S.wrapper.querySelector(d).classList.contains("present")&&setTimeout(function(){var e,t=Z(S.wrapper.querySelectorAll(c+".stack"))
for(e in t)t[e]&&ge(t[e],0)},0))
e:for(var y=0,b=w.length;y<b;y++){for(var _=0;_<l.length;_++)if(l[_]===w[y]){l.splice(_,1)
continue e}document.documentElement.classList.add(w[y]),ue(w[y])}for(;l.length;)document.documentElement.classList.remove(l.pop())
g&&ue("slidechanged",{indexh:t,indexv:n,previousSlide:r,currentSlide:i,origin:s}),!g&&r||(et(r),Xe(i)),S.statusDiv.textContent=V(i),Ve(),qe(),We(),Ye(),Ue(),Be(),pt(),ot(),yt()}}function Le(){var e
X(),Q(),pe(),N=p.autoSlide,yt(),ae(),S.background.innerHTML="",S.background.classList.add("no-transition"),Z(S.wrapper.querySelectorAll(c)).forEach(function(e){var t=K(e,S.background)
Z(e.querySelectorAll("section")).forEach(function(e){K(e,t),t.classList.add("stack")})}),p.parallaxBackgroundImage?(S.background.style.backgroundImage='url("'+p.parallaxBackgroundImage+'")',S.background.style.backgroundSize=p.parallaxBackgroundSize,S.background.style.backgroundRepeat=p.parallaxBackgroundRepeat,S.background.style.backgroundPosition=p.parallaxBackgroundPosition,setTimeout(function(){S.wrapper.classList.add("has-parallax-background")},1)):(S.background.style.backgroundImage="",S.wrapper.classList.remove("has-parallax-background")),ot(),Z(S.wrapper.querySelectorAll(c)).forEach(function(e){var t=Z(e.querySelectorAll("section"))
t.forEach(function(e,t){ft(e.querySelectorAll(".fragment"))}),0===t.length&&ft(e.querySelectorAll(".fragment"))}),Ve(),qe(),Ue(),ze(),We(!0),p.showNotes&&S.slides.querySelectorAll("[data-notes], aside.notes").length>0?S.wrapper.classList.add("show-notes"):S.wrapper.classList.remove("show-notes"),Be(),(e=function(e,t,n){Z(S.slides.querySelectorAll("iframe["+e+'*="'+t+'"]')).forEach(function(t){var r=t.getAttribute(e)
r&&-1===r.indexOf(n)&&t.setAttribute(e,r+(/\?/.test(r)?"&":"?")+n)})})("src","youtube.com/embed/","enablejsapi=1"),e("data-src","youtube.com/embed/","enablejsapi=1"),e("src","player.vimeo.com/","api=1"),e("data-src","player.vimeo.com/","api=1"),!1===p.autoPlayMedia?et(i,{unloadIframes:!1}):Xe(i),Ae()&&_e()}function je(e){return ft((e=e||i).querySelectorAll(".fragment"))}function Ie(){var e=Z(S.wrapper.querySelectorAll(c))
e.forEach(function(t){S.slides.insertBefore(t,e[Math.floor(Math.random()*e.length)])})}function Fe(e,t){var n=Z(S.wrapper.querySelectorAll(e)),r=n.length,i=ae()
if(r){p.loop&&(t%=r)<0&&(t=r+t),t=Math.max(Math.min(t,r-1),0)
for(var o=0;o<r;o++){var a=n[o],s=p.rtl&&!ke(a)
a.classList.remove("past"),a.classList.remove("present"),a.classList.remove("future"),a.setAttribute("hidden",""),a.setAttribute("aria-hidden","true"),a.querySelector("section")&&a.classList.add("stack"),i?a.classList.add("present"):o<t?(a.classList.add(s?"future":"past"),p.fragments&&Z(a.querySelectorAll(".fragment")).forEach(function(e){e.classList.add("visible"),e.classList.remove("current-fragment")})):o>t&&(a.classList.add(s?"past":"future"),p.fragments&&Z(a.querySelectorAll(".fragment.visible")).forEach(function(e){e.classList.remove("visible"),e.classList.remove("current-fragment")}))}n[t].classList.add("present"),n[t].removeAttribute("hidden"),n[t].removeAttribute("aria-hidden")
var u=n[t].getAttribute("data-state")
u&&(w=w.concat(u.split(" ")))}else t=0
return t}function ze(){var e,r=Z(S.wrapper.querySelectorAll(c)),i=r.length
if(i&&void 0!==t){var o=Ae()?10:p.viewDistance
a&&(o=Ae()?6:2),ae()&&(o=Number.MAX_VALUE)
for(var s=0;s<i;s++){var u=r[s],l=Z(u.querySelectorAll("section")),h=l.length
if(e=Math.abs((t||0)-s)||0,p.loop&&(e=Math.abs(((t||0)-s)%(i-o))||0),e<o?Ke(u):Ge(u),h)for(var d=ye(u),f=0;f<h;f++){var m=l[f]
e+(s===(t||0)?Math.abs((n||0)-f):Math.abs(f-d))<o?Ke(m):Ge(m)}}S.wrapper.querySelectorAll(".slides>section>section").length?S.wrapper.classList.add("has-vertical-slides"):S.wrapper.classList.remove("has-vertical-slides"),S.wrapper.querySelectorAll(".slides>section").length>1?S.wrapper.classList.add("has-horizontal-slides"):S.wrapper.classList.remove("has-horizontal-slides")}}function Be(){p.showNotes&&S.speakerNotes&&i&&!ae()&&(S.speakerNotes.innerHTML=ht()||'<span class="notes-placeholder">No notes on this slide.</span>')}function qe(){p.progress&&S.progressbar&&(S.progressbar.style.width=nt()*S.wrapper.offsetWidth+"px")}function Ue(){if(p.slideNumber&&S.slideNumber){var e,r="h.v"
if("function"==typeof p.slideNumber)e=p.slideNumber()
else switch("string"==typeof p.slideNumber&&(r=p.slideNumber),/c/.test(r)||1!==S.wrapper.querySelectorAll(c).length||(r="c"),e=[],r){case"c":e.push(tt()+1)
break
case"c/t":e.push(tt()+1,"/",ut())
break
case"h/v":e.push(t+1),ke()&&e.push("/",n+1)
break
default:e.push(t+1),ke()&&e.push(".",n+1)}S.slideNumber.innerHTML=He(e[0],e[1],e[2])}}function He(e,t,n){var r="#"+Se()
return"number"!=typeof n||isNaN(n)?'<a href="'+r+'"><span class="slide-number-a">'+e+"</span></a>":'<a href="'+r+'"><span class="slide-number-a">'+e+'</span><span class="slide-number-delimiter">'+t+'</span><span class="slide-number-b">'+n+"</span></a>"}function Ve(){var e=$e(),t=Qe()
S.controlsLeft.concat(S.controlsRight).concat(S.controlsUp).concat(S.controlsDown).concat(S.controlsPrev).concat(S.controlsNext).forEach(function(e){e.classList.remove("enabled"),e.classList.remove("fragmented"),e.setAttribute("disabled","disabled")}),e.left&&S.controlsLeft.forEach(function(e){e.classList.add("enabled"),e.removeAttribute("disabled")}),e.right&&S.controlsRight.forEach(function(e){e.classList.add("enabled"),e.removeAttribute("disabled")}),e.up&&S.controlsUp.forEach(function(e){e.classList.add("enabled"),e.removeAttribute("disabled")}),e.down&&S.controlsDown.forEach(function(e){e.classList.add("enabled"),e.removeAttribute("disabled")}),(e.left||e.up)&&S.controlsPrev.forEach(function(e){e.classList.add("enabled"),e.removeAttribute("disabled")}),(e.right||e.down)&&S.controlsNext.forEach(function(e){e.classList.add("enabled"),e.removeAttribute("disabled")}),i&&(t.prev&&S.controlsPrev.forEach(function(e){e.classList.add("fragmented","enabled"),e.removeAttribute("disabled")}),t.next&&S.controlsNext.forEach(function(e){e.classList.add("fragmented","enabled"),e.removeAttribute("disabled")}),ke(i)?(t.prev&&S.controlsUp.forEach(function(e){e.classList.add("fragmented","enabled"),e.removeAttribute("disabled")}),t.next&&S.controlsDown.forEach(function(e){e.classList.add("fragmented","enabled"),e.removeAttribute("disabled")})):(t.prev&&S.controlsLeft.forEach(function(e){e.classList.add("fragmented","enabled"),e.removeAttribute("disabled")}),t.next&&S.controlsRight.forEach(function(e){e.classList.add("fragmented","enabled"),e.removeAttribute("disabled")}))),p.controlsTutorial&&(!E&&e.down?S.controlsDownArrow.classList.add("highlight"):(S.controlsDownArrow.classList.remove("highlight"),!_&&e.right&&0===n?S.controlsRightArrow.classList.add("highlight"):S.controlsRightArrow.classList.remove("highlight")))}function We(e){var r=null,a=p.rtl?"future":"past",s=p.rtl?"past":"future"
if(Z(S.background.childNodes).forEach(function(i,o){i.classList.remove("past"),i.classList.remove("present"),i.classList.remove("future"),o<t?i.classList.add(a):o>t?i.classList.add(s):(i.classList.add("present"),r=i),(e||o===t)&&Z(i.querySelectorAll(".slide-background")).forEach(function(e,i){e.classList.remove("past"),e.classList.remove("present"),e.classList.remove("future"),i<n?e.classList.add("past"):i>n?e.classList.add("future"):(e.classList.add("present"),o===t&&(r=e))})}),o&&et(o),r){Xe(r)
var u=r.querySelector(".slide-background-content")
if(u){var l=u.style.backgroundImage||"";/\.gif/i.test(l)&&(u.style.backgroundImage="",window.getComputedStyle(u).opacity,u.style.backgroundImage=l)}var c=o?o.getAttribute("data-background-hash"):null,h=r.getAttribute("data-background-hash")
h&&h===c&&r!==o&&S.background.classList.add("no-transition"),o=r}i&&["has-light-background","has-dark-background"].forEach(function(e){i.classList.contains(e)?S.wrapper.classList.add(e):S.wrapper.classList.remove(e)}),setTimeout(function(){S.background.classList.remove("no-transition")},1)}function Ye(){if(p.parallaxBackgroundImage){var e,r,i=S.wrapper.querySelectorAll(c),o=S.wrapper.querySelectorAll(h),a=S.background.style.backgroundSize.split(" ")
1===a.length?e=r=parseInt(a[0],10):(e=parseInt(a[0],10),r=parseInt(a[1],10))
var s,u=S.background.offsetWidth,l=i.length
s=("number"==typeof p.parallaxBackgroundHorizontal?p.parallaxBackgroundHorizontal:l>1?(e-u)/(l-1):0)*t*-1
var d,f,m=S.background.offsetHeight,v=o.length
d="number"==typeof p.parallaxBackgroundVertical?p.parallaxBackgroundVertical:(r-m)/(v-1),f=v>0?d*n:0,S.background.style.backgroundPosition=s+"px "+-f+"px"}}function Ke(e,t){t=t||{},e.style.display=p.display,Z(e.querySelectorAll("img[data-src], video[data-src], audio[data-src], iframe[data-src]")).forEach(function(e){("IFRAME"!==e.tagName||function(e){var t=p.preloadIframes
return"boolean"!=typeof t&&(t=e.hasAttribute("data-preload")),t}(e))&&(e.setAttribute("src",e.getAttribute("data-src")),e.setAttribute("data-lazy-loaded",""),e.removeAttribute("data-src"))}),Z(e.querySelectorAll("video, audio")).forEach(function(e){var t=0
Z(e.querySelectorAll("source[data-src]")).forEach(function(e){e.setAttribute("src",e.getAttribute("data-src")),e.removeAttribute("data-src"),e.setAttribute("data-lazy-loaded",""),t+=1}),t>0&&e.load()})
var n=e.slideBackgroundElement
if(n){n.style.display="block"
var r=e.slideBackgroundContentElement
if(!1===n.hasAttribute("data-loaded")){n.setAttribute("data-loaded","true")
var i=e.getAttribute("data-background-image"),o=e.getAttribute("data-background-video"),s=e.hasAttribute("data-background-video-loop"),u=e.hasAttribute("data-background-video-muted"),l=e.getAttribute("data-background-iframe")
if(i)r.style.backgroundImage="url("+encodeURI(i)+")"
else if(o&&!rt()){var c=document.createElement("video")
s&&c.setAttribute("loop",""),u&&(c.muted=!0),a&&(c.muted=!0,c.autoplay=!0,c.setAttribute("playsinline","")),o.split(",").forEach(function(e){c.innerHTML+='<source src="'+e+'">'}),r.appendChild(c)}else if(l&&!0!==t.excludeIframes){var h=document.createElement("iframe")
h.setAttribute("allowfullscreen",""),h.setAttribute("mozallowfullscreen",""),h.setAttribute("webkitallowfullscreen",""),/autoplay=(1|true|yes)/gi.test(l)?h.setAttribute("data-src",l):h.setAttribute("src",l),h.style.width="100%",h.style.height="100%",h.style.maxHeight="100%",h.style.maxWidth="100%",r.appendChild(h)}}}}function Ge(e){e.style.display="none"
var t=ct(e)
t&&(t.style.display="none"),Z(e.querySelectorAll("video[data-lazy-loaded][src], audio[data-lazy-loaded][src], iframe[data-lazy-loaded][src]")).forEach(function(e){e.setAttribute("data-src",e.getAttribute("src")),e.removeAttribute("src")}),Z(e.querySelectorAll("video[data-lazy-loaded] source[src], audio source[src]")).forEach(function(e){e.setAttribute("data-src",e.getAttribute("src")),e.removeAttribute("src")})}function $e(){var e=S.wrapper.querySelectorAll(c),r=S.wrapper.querySelectorAll(h),i={left:t>0,right:t<e.length-1,up:n>0,down:n<r.length-1}
if(p.loop&&(e.length>1&&(i.left=!0,i.right=!0),r.length>1&&(i.up=!0,i.down=!0)),p.rtl){var o=i.left
i.left=i.right,i.right=o}return i}function Qe(){if(i&&p.fragments){var e=i.querySelectorAll(".fragment"),t=i.querySelectorAll(".fragment:not(.visible)")
return{prev:e.length-t.length>0,next:!!t.length}}return{prev:!1,next:!1}}function Xe(e){e&&!rt()&&(Z(e.querySelectorAll('img[src$=".gif"]')).forEach(function(e){e.setAttribute("src",e.getAttribute("src"))}),Z(e.querySelectorAll("video, audio")).forEach(function(e){if(!ie(e,".fragment")||ie(e,".fragment.visible")){var t=p.autoPlayMedia
if("boolean"!=typeof t&&(t=e.hasAttribute("data-autoplay")||!!ie(e,".slide-background")),t&&"function"==typeof e.play)if(e.readyState>1)Je({target:e})
else if(a){var n=e.play()
n&&"function"==typeof n.catch&&!1===e.controls&&n.catch(function(){e.controls=!0,e.addEventListener("play",function(){e.controls=!1})})}else e.removeEventListener("loadeddata",Je),e.addEventListener("loadeddata",Je)}}),Z(e.querySelectorAll("iframe[src]")).forEach(function(e){ie(e,".fragment")&&!ie(e,".fragment.visible")||Ze({target:e})}),Z(e.querySelectorAll("iframe[data-src]")).forEach(function(e){ie(e,".fragment")&&!ie(e,".fragment.visible")||e.getAttribute("src")!==e.getAttribute("data-src")&&(e.removeEventListener("load",Ze),e.addEventListener("load",Ze),e.setAttribute("src",e.getAttribute("data-src")))}))}function Je(e){var t=!!ie(e.target,"html"),n=!!ie(e.target,".present")
t&&n&&(e.target.currentTime=0,e.target.play()),e.target.removeEventListener("loadeddata",Je)}function Ze(e){var t=e.target
if(t&&t.contentWindow){var n=!!ie(e.target,"html"),r=!!ie(e.target,".present")
if(n&&r){var i=p.autoPlayMedia
"boolean"!=typeof i&&(i=t.hasAttribute("data-autoplay")||!!ie(t,".slide-background")),/youtube\.com\/embed\//.test(t.getAttribute("src"))&&i?t.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}',"*"):/player\.vimeo\.com\//.test(t.getAttribute("src"))&&i?t.contentWindow.postMessage('{"method":"play"}',"*"):t.contentWindow.postMessage("slide:start","*")}}}function et(e,t){t=J({unloadIframes:!0},t||{}),e&&e.parentNode&&(Z(e.querySelectorAll("video, audio")).forEach(function(e){e.hasAttribute("data-ignore")||"function"!=typeof e.pause||(e.setAttribute("data-paused-by-reveal",""),e.pause())}),Z(e.querySelectorAll("iframe")).forEach(function(e){e.contentWindow&&e.contentWindow.postMessage("slide:stop","*"),e.removeEventListener("load",Ze)}),Z(e.querySelectorAll('iframe[src*="youtube.com/embed/"]')).forEach(function(e){!e.hasAttribute("data-ignore")&&e.contentWindow&&"function"==typeof e.contentWindow.postMessage&&e.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")}),Z(e.querySelectorAll('iframe[src*="player.vimeo.com/"]')).forEach(function(e){!e.hasAttribute("data-ignore")&&e.contentWindow&&"function"==typeof e.contentWindow.postMessage&&e.contentWindow.postMessage('{"method":"pause"}',"*")}),!0===t.unloadIframes&&Z(e.querySelectorAll("iframe[data-src]")).forEach(function(e){e.setAttribute("src","about:blank"),e.removeAttribute("src")}))}function tt(){var e=Z(S.wrapper.querySelectorAll(c)),t=0
e:for(var n=0;n<e.length;n++){for(var r=e[n],i=Z(r.querySelectorAll("section")),o=0;o<i.length;o++){if(i[o].classList.contains("present"))break e
t++}if(r.classList.contains("present"))break
!1===r.classList.contains("stack")&&t++}return t}function nt(){var e=ut(),t=tt()
if(i){var n=i.querySelectorAll(".fragment")
if(n.length>0){t+=i.querySelectorAll(".fragment.visible").length/n.length*.9}}return Math.min(t/(e-1),1)}function rt(){return!!window.location.search.match(/receiver/gi)}function it(){var r=window.location.hash,o=r.slice(2).split("/"),a=r.replace(/#|\//gi,"")
if(!/^[0-9]*$/.test(o[0])&&a.length){var s
try{s=document.getElementById(decodeURIComponent(a))}catch(m){}var u=!!i&&i.getAttribute("id")===a
if(s){if(!u){var l=e.getIndices(s)
Ne(l.h,l.v)}}else Ne(t||0,n||0)}else{var c,h=p.hashOneBasedIndex?1:0,d=parseInt(o[0],10)-h||0,f=parseInt(o[1],10)-h||0
p.fragmentInURL&&(c=parseInt(o[2],10),isNaN(c)&&(c=void 0)),d===t&&f===n&&void 0===c||Ne(d,f,c)}}function ot(e){clearTimeout(O),"number"==typeof e?O=setTimeout(ot,e):i&&(p.history||!window.history?window.location.hash=Se():p.hash?window.history.replaceState(null,null,"#"+Se()):window.history.replaceState(null,null,window.location.pathname+window.location.search))}function at(e){var r,o=t,a=n
if(e){var s=ke(e),u=s?e.parentNode:e,l=Z(S.wrapper.querySelectorAll(c))
o=Math.max(l.indexOf(u),0),a=void 0,s&&(a=Math.max(Z(e.parentNode.querySelectorAll("section")).indexOf(e),0))}if(!e&&i&&i.querySelectorAll(".fragment").length>0){var h=i.querySelector(".current-fragment")
r=h&&h.hasAttribute("data-fragment-index")?parseInt(h.getAttribute("data-fragment-index"),10):i.querySelectorAll(".fragment.visible").length-1}return{h:o,v:a,f:r}}function st(){return Z(S.wrapper.querySelectorAll(l+":not(.stack)"))}function ut(){return st().length}function lt(e,t){var n=S.wrapper.querySelectorAll(c)[e],r=n&&n.querySelectorAll("section")
return r&&r.length&&"number"==typeof t?r?r[t]:void 0:n}function ct(e,t){var n="number"==typeof e?lt(e,t):e
if(n)return n.slideBackgroundElement}function ht(e){if((e=e||i).hasAttribute("data-notes"))return e.getAttribute("data-notes")
var t=e.querySelector("aside.notes")
return t?t.innerHTML:null}function dt(){var e=at()
return{indexh:e.h,indexv:e.v,indexf:e.f,paused:Pe(),overview:Ae()}}function ft(e,t){e=Z(e)
var n=[],r=[],i=[]
e.forEach(function(e,t){if(e.hasAttribute("data-fragment-index")){var i=parseInt(e.getAttribute("data-fragment-index"),10)
n[i]||(n[i]=[]),n[i].push(e)}else r.push([e])}),n=n.concat(r)
var o=0
return n.forEach(function(e){e.forEach(function(e){i.push(e),e.setAttribute("data-fragment-index",o)}),o++}),!0===t?n:i}function pt(e,t){var n={shown:[],hidden:[]}
if(i&&p.fragments&&(t=t||ft(i.querySelectorAll(".fragment"))).length){if("number"!=typeof e){var r=ft(i.querySelectorAll(".fragment.visible")).pop()
r&&(e=parseInt(r.getAttribute("data-fragment-index")||0,10))}Z(t).forEach(function(t,r){t.hasAttribute("data-fragment-index")&&(r=parseInt(t.getAttribute("data-fragment-index"),10)),r<=e?(t.classList.contains("visible")||n.shown.push(t),t.classList.add("visible"),t.classList.remove("current-fragment"),S.statusDiv.textContent=V(t),r===e&&(t.classList.add("current-fragment"),Xe(t))):(t.classList.contains("visible")&&n.hidden.push(t),t.classList.remove("visible"),t.classList.remove("current-fragment"))})}return n}function mt(e,t){if(i&&p.fragments){var n=ft(i.querySelectorAll(".fragment"))
if(n.length){if("number"!=typeof e){var r=ft(i.querySelectorAll(".fragment.visible")).pop()
e=r?parseInt(r.getAttribute("data-fragment-index")||0,10):-1}"number"==typeof t&&(e+=t)
var o=pt(e,n)
return o.hidden.length&&ue("fragmenthidden",{fragment:o.hidden[0],fragments:o.hidden}),o.shown.length&&ue("fragmentshown",{fragment:o.shown[0],fragments:o.shown}),Ve(),qe(),p.fragmentInURL&&ot(),!(!o.shown.length&&!o.hidden.length)}}return!1}function vt(){return mt(null,1)}function gt(){return mt(null,-1)}function yt(){if(bt(),i&&!1!==p.autoSlide){var t=i.querySelector(".current-fragment")
t||(t=i.querySelector(".fragment"))
var n=t?t.getAttribute("data-autoslide"):null,r=i.parentNode?i.parentNode.getAttribute("data-autoslide"):null,o=i.getAttribute("data-autoslide")
N=n?parseInt(n,10):o?parseInt(o,10):r?parseInt(r,10):p.autoSlide,0===i.querySelectorAll(".fragment").length&&Z(i.querySelectorAll("video, audio")).forEach(function(e){e.hasAttribute("data-autoplay")&&N&&1e3*e.duration/e.playbackRate>N&&(N=1e3*e.duration/e.playbackRate+1e3)}),!N||I||Pe()||Ae()||e.isLastSlide()&&!Qe().next&&!0!==p.loop||(L=setTimeout(function(){"function"==typeof p.autoSlideMethod?p.autoSlideMethod():xt(),yt()},N),j=Date.now()),u&&u.setPlaying(-1!==L)}}function bt(){clearTimeout(L),L=-1}function _t(){N&&!I&&(I=!0,ue("autoslidepaused"),clearTimeout(L),u&&u.setPlaying(!1))}function Et(){N&&I&&(I=!1,ue("autoslideresumed"),yt())}function wt(){p.rtl?(Ae()||!1===vt())&&$e().left&&Ne(t+1,"grid"===p.navigationMode?n:void 0):(Ae()||!1===gt())&&$e().left&&Ne(t-1,"grid"===p.navigationMode?n:void 0)}function Rt(){_=!0,p.rtl?(Ae()||!1===gt())&&$e().right&&Ne(t-1,"grid"===p.navigationMode?n:void 0):(Ae()||!1===vt())&&$e().right&&Ne(t+1,"grid"===p.navigationMode?n:void 0)}function At(){(Ae()||!1===gt())&&$e().up&&Ne(t,n-1)}function St(){E=!0,(Ae()||!1===vt())&&$e().down&&Ne(t,n+1)}function kt(){var e
if(!1===gt())if($e().up)At()
else if(e=p.rtl?Z(S.wrapper.querySelectorAll(c+".future")).pop():Z(S.wrapper.querySelectorAll(c+".past")).pop()){var n=e.querySelectorAll("section").length-1||void 0
Ne(t-1,n)}}function xt(){if(_=!0,E=!0,!1===vt()){var t=$e()
t.down&&t.right&&p.loop&&e.isLastVerticalSlide(i)&&(t.down=!1),t.down?St():p.rtl?wt():Rt()}}function Tt(e){for(;e&&"function"==typeof e.hasAttribute;){if(e.hasAttribute("data-prevent-swipe"))return!0
e=e.parentNode}return!1}function Ct(e){p.autoSlideStoppable&&_t()}function Ot(e){xe(),clearTimeout(P),P=setTimeout(Te,p.hideCursorTime)}function Mt(e){e.shiftKey&&63===e.charCode&&he()}function Pt(t){if("function"==typeof p.keyboardCondition&&!1===p.keyboardCondition(t))return!0
var n=t.keyCode,r=I
Ct()
var i=document.activeElement&&"inherit"!==document.activeElement.contentEditable,o=document.activeElement&&document.activeElement.tagName&&/input|textarea/i.test(document.activeElement.tagName),a=document.activeElement&&document.activeElement.className&&/speaker-notes/i.test(document.activeElement.className),s=t.shiftKey&&32===t.keyCode,u=(t.metaKey||t.ctrlKey)&&37===n,l=(t.metaKey||t.ctrlKey)&&39===n,c=!s&&!u&&!l&&(t.shiftKey||t.altKey||t.ctrlKey||t.metaKey)
if(!(i||o||a||c)){var h,d=[66,86,190,191]
if("object"==typeof p.keyboard)for(h in p.keyboard)"togglePause"===p.keyboard[h]&&d.push(parseInt(h,10))
if(Pe()&&-1===d.indexOf(n))return!1
var f,m,v=!1
if("object"==typeof p.keyboard)for(h in p.keyboard)if(parseInt(h,10)===n){var g=p.keyboard[h]
"function"==typeof g?g.apply(null,[t]):"string"==typeof g&&"function"==typeof e[g]&&e[g].call(),v=!0}if(!1===v)for(h in B)if(parseInt(h,10)===n){var y=B[h].callback
"function"==typeof y?y.apply(null,[t]):"string"==typeof y&&"function"==typeof e[y]&&e[y].call(),v=!0}!1===v&&(v=!0,80===n||33===n?kt():78===n||34===n?xt():72===n||37===n?u?Ne(0):Ae()||"linear"!==p.navigationMode?wt():kt():76===n||39===n?l?Ne(Number.MAX_VALUE):Ae()||"linear"!==p.navigationMode?Rt():xt():75===n||38===n?Ae()||"linear"!==p.navigationMode?At():kt():74===n||40===n?Ae()||"linear"!==p.navigationMode?St():xt():36===n?Ne(0):35===n?Ne(Number.MAX_VALUE):32===n?(Ae()&&we(),t.shiftKey?kt():xt()):58===n||59===n||66===n||86===n||190===n||191===n?Me():70===n?(f=document.documentElement,(m=f.requestFullscreen||f.webkitRequestFullscreen||f.webkitRequestFullScreen||f.mozRequestFullScreen||f.msRequestFullscreen)&&m.apply(f)):65===n?p.autoSlideStoppable&&De(r):v=!1),v?t.preventDefault&&t.preventDefault():27!==n&&79!==n||!T.transforms3d||(S.overlay?fe():Re(),t.preventDefault&&t.preventDefault()),yt()}}function Dt(e){if(Tt(e.target))return!0
F.startX=e.touches[0].clientX,F.startY=e.touches[0].clientY,F.startCount=e.touches.length}function Nt(e){if(Tt(e.target))return!0
if(F.captured)f.match(/android/gi)&&e.preventDefault()
else{Ct()
var t=e.touches[0].clientX,n=e.touches[0].clientY
if(1===e.touches.length&&2!==F.startCount){var r=t-F.startX,o=n-F.startY
r>F.threshold&&Math.abs(r)>Math.abs(o)?(F.captured=!0,wt()):r<-F.threshold&&Math.abs(r)>Math.abs(o)?(F.captured=!0,Rt()):o>F.threshold?(F.captured=!0,At()):o<-F.threshold&&(F.captured=!0,St()),p.embedded?(F.captured||ke(i))&&e.preventDefault():e.preventDefault()}}}function Lt(e){F.captured=!1}function jt(e){e.pointerType!==e.MSPOINTER_TYPE_TOUCH&&"touch"!==e.pointerType||(e.touches=[{clientX:e.clientX,clientY:e.clientY}],Dt(e))}function It(e){e.pointerType!==e.MSPOINTER_TYPE_TOUCH&&"touch"!==e.pointerType||(e.touches=[{clientX:e.clientX,clientY:e.clientY}],Nt(e))}function Ft(e){e.pointerType!==e.MSPOINTER_TYPE_TOUCH&&"touch"!==e.pointerType||(e.touches=[{clientX:e.clientX,clientY:e.clientY}],Lt())}function zt(e){if(Date.now()-C>600){C=Date.now()
var t=e.detail||-e.wheelDelta
t>0?xt():t<0&&kt()}}function Bt(e){Ct(),e.preventDefault()
var t=Z(S.wrapper.querySelectorAll(c)).length,n=Math.floor(e.clientX/S.wrapper.offsetWidth*t)
p.rtl&&(n=t-n),Ne(n)}function qt(e){e.preventDefault(),Ct(),"linear"===p.navigationMode?kt():wt()}function Ut(e){e.preventDefault(),Ct(),"linear"===p.navigationMode?xt():Rt()}function Ht(e){e.preventDefault(),Ct(),At()}function Vt(e){e.preventDefault(),Ct(),St()}function Wt(e){e.preventDefault(),Ct(),kt()}function Yt(e){e.preventDefault(),Ct(),xt()}function Kt(e){it()}function Gt(e){pe()}function $t(e){!1===(document.webkitHidden||document.msHidden||document.hidden)&&document.activeElement!==document.body&&("function"==typeof document.activeElement.blur&&document.activeElement.blur(),document.body.focus())}function Qt(e){if(D&&Ae()){e.preventDefault()
for(var t=e.target;t&&!t.nodeName.match(/section/gi);)t=t.parentNode
if(t&&!t.classList.contains("disabled"))if(we(),t.nodeName.match(/section/gi))Ne(parseInt(t.getAttribute("data-index-h"),10),parseInt(t.getAttribute("data-index-v"),10))}}function Xt(e){if(e.currentTarget&&e.currentTarget.hasAttribute("href")){var t=e.currentTarget.getAttribute("href")
t&&(function(e){fe(),S.overlay=document.createElement("div"),S.overlay.classList.add("overlay"),S.overlay.classList.add("overlay-preview"),S.wrapper.appendChild(S.overlay),S.overlay.innerHTML=["<header>",'<a class="close" href="#"><span class="icon"></span></a>','<a class="external" href="'+e+'" target="_blank"><span class="icon"></span></a>',"</header>",'<div class="spinner"></div>','<div class="viewport">','<iframe src="'+e+'"></iframe>','<small class="viewport-inner">','<span class="x-frame-error">Unable to load iframe. This is likely due to the site\'s policy (x-frame-options).</span>',"</small>","</div>"].join(""),S.overlay.querySelector("iframe").addEventListener("load",function(e){S.overlay.classList.add("loaded")},!1),S.overlay.querySelector(".close").addEventListener("click",function(e){fe(),e.preventDefault()},!1),S.overlay.querySelector(".external").addEventListener("click",function(e){fe()},!1),setTimeout(function(){S.overlay.classList.add("visible")},1)}(t),e.preventDefault())}}function Jt(t){e.isLastSlide()&&!1===p.loop?(Ne(0,0),Et()):I?Et():_t()}function Zt(e,t){this.diameter=100,this.diameter2=this.diameter/2,this.thickness=6,this.playing=!1,this.progress=0,this.progressOffset=1,this.container=e,this.progressCheck=t,this.canvas=document.createElement("canvas"),this.canvas.className="playback",this.canvas.width=this.diameter,this.canvas.height=this.diameter,this.canvas.style.width=this.diameter2+"px",this.canvas.style.height=this.diameter2+"px",this.context=this.canvas.getContext("2d"),this.container.appendChild(this.canvas),this.render()}return Zt.prototype.setPlaying=function(e){var t=this.playing
this.playing=e,!t&&this.playing?this.animate():this.render()},Zt.prototype.animate=function(){var e=this.progress
this.progress=this.progressCheck(),e>.8&&this.progress<.2&&(this.progressOffset=this.progress),this.render(),this.playing&&T.requestAnimationFrameMethod.call(window,this.animate.bind(this))},Zt.prototype.render=function(){var e=this.playing?this.progress:0,t=this.diameter2-this.thickness,n=this.diameter2,r=this.diameter2
this.progressOffset+=.1*(1-this.progressOffset)
var i=-Math.PI/2+e*(2*Math.PI),o=-Math.PI/2+this.progressOffset*(2*Math.PI)
this.context.save(),this.context.clearRect(0,0,this.diameter,this.diameter),this.context.beginPath(),this.context.arc(n,r,t+4,0,2*Math.PI,!1),this.context.fillStyle="rgba( 0, 0, 0, 0.4 )",this.context.fill(),this.context.beginPath(),this.context.arc(n,r,t,0,2*Math.PI,!1),this.context.lineWidth=this.thickness,this.context.strokeStyle="rgba( 255, 255, 255, 0.2 )",this.context.stroke(),this.playing&&(this.context.beginPath(),this.context.arc(n,r,t,o,i,!1),this.context.lineWidth=this.thickness,this.context.strokeStyle="#fff",this.context.stroke()),this.context.translate(n-14,r-14),this.playing?(this.context.fillStyle="#fff",this.context.fillRect(0,0,10,28),this.context.fillRect(18,0,10,28)):(this.context.beginPath(),this.context.translate(4,0),this.context.moveTo(0,0),this.context.lineTo(24,14),this.context.lineTo(0,28),this.context.fillStyle="#fff",this.context.fill()),this.context.restore()},Zt.prototype.on=function(e,t){this.canvas.addEventListener(e,t,!1)},Zt.prototype.off=function(e,t){this.canvas.removeEventListener(e,t,!1)},Zt.prototype.destroy=function(){this.playing=!1,this.canvas.parentNode&&this.container.removeChild(this.canvas)},e={VERSION:"3.8.0",initialize:function(t){if(!0!==m)if(m=!0,function(){a=/(iphone|ipod|ipad|android)/gi.test(f),s=/chrome/i.test(f)&&!/edge/i.test(f)
var e=document.createElement("div")
T.transforms3d="WebkitPerspective"in e.style||"MozPerspective"in e.style||"msPerspective"in e.style||"OPerspective"in e.style||"perspective"in e.style,T.transforms2d="WebkitTransform"in e.style||"MozTransform"in e.style||"msTransform"in e.style||"OTransform"in e.style||"transform"in e.style,T.requestAnimationFrameMethod=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame,T.requestAnimationFrame="function"==typeof T.requestAnimationFrameMethod,T.canvas=!!document.createElement("canvas").getContext,T.overviewTransitions=!/Version\/[\d\.]+.*Safari/.test(f),T.zoom="zoom"in e.style&&!a&&(s||/Version\/[\d\.]+.*Safari/.test(f))}(),T.transforms2d||T.transforms3d){S.wrapper=document.querySelector(".reveal"),S.slides=document.querySelector(".reveal .slides"),window.addEventListener("load",pe,!1)
var n,r,i=e.getQueryHash()
void 0!==i.dependencies&&delete i.dependencies,J(p,t),J(p,i),p.hideAddressBar&&a&&(window.addEventListener("load",se,!1),window.addEventListener("orientationchange",se,!1)),n=[],r=0,p.dependencies.forEach(function(e){e.condition&&!e.condition()||(e.async?x.push(e):n.push(e))}),n.length?(r=n.length,n.forEach(function(e){H(e.src,function(){"function"==typeof e.callback&&e.callback(),0==--r&&q()})})):q()}else{document.body.setAttribute("class","no-transforms")
for(var o=Z(document.getElementsByTagName("img")),u=Z(document.getElementsByTagName("iframe")),l=o.concat(u),c=0,h=l.length;c<h;c++){var d=l[c]
d.getAttribute("data-src")&&(d.setAttribute("src",d.getAttribute("data-src")),d.removeAttribute("data-src"))}}},configure:$,sync:Le,syncSlide:function(e){G(e=e||i),je(e),We(),Be(),Ke(e)},syncFragments:je,slide:Ne,left:wt,right:Rt,up:At,down:St,prev:kt,next:xt,navigateFragment:mt,prevFragment:gt,nextFragment:vt,navigateTo:Ne,navigateLeft:wt,navigateRight:Rt,navigateUp:At,navigateDown:St,navigatePrev:kt,navigateNext:xt,layout:pe,shuffle:Ie,availableRoutes:$e,availableFragments:Qe,toggleHelp:he,toggleOverview:Re,togglePause:Me,toggleAutoSlide:De,isOverview:Ae,isPaused:Pe,isAutoSliding:function(){return!(!N||I)},isSpeakerNotes:rt,loadSlide:Ke,unloadSlide:Ge,addEventListeners:Q,removeEventListeners:X,getState:dt,setState:function(e){if("object"==typeof e){Ne(ee(e.indexh),ee(e.indexv),ee(e.indexf))
var t=ee(e.paused),n=ee(e.overview)
"boolean"==typeof t&&t!==Pe()&&Me(t),"boolean"==typeof n&&n!==Ae()&&Re(n)}},getSlidePastCount:tt,getProgress:nt,getIndices:at,getSlides:st,getSlidesAttributes:function(){return st().map(function(e){for(var t={},n=0;n<e.attributes.length;n++){var r=e.attributes[n]
t[r.name]=r.value}return t})},getTotalSlides:ut,getSlide:lt,getSlideBackground:ct,getSlideNotes:ht,getPreviousSlide:function(){return r},getCurrentSlide:function(){return i},getScale:function(){return R},getConfig:function(){return p},getQueryHash:function(){var e={}
for(var t in location.search.replace(/[A-Z0-9]+?=([\w\.%-]*)/gi,function(t){e[t.split("=").shift()]=t.split("=").pop()}),e){var n=e[t]
e[t]=ee(unescape(n))}return e},getRevealElement:function(){return S.wrapper||document.querySelector(".reveal")},getPlugins:function(){return k},isFirstSlide:function(){return 0===t&&0===n},isLastSlide:function(){return!!i&&(!i.nextElementSibling&&(!ke(i)||!i.parentNode.nextElementSibling))},isLastVerticalSlide:function(){return!(!i||!ke(i))&&!i.nextElementSibling},isReady:function(){return v},addEventListener:function(t,n,r){"addEventListener"in window&&e.getRevealElement().addEventListener(t,n,r)},removeEventListener:function(t,n,r){"addEventListener"in window&&e.getRevealElement().removeEventListener(t,n,r)},addKeyBinding:function(e,t){"object"==typeof e&&e.keyCode?B[e.keyCode]={callback:t,key:e.key,description:e.description}:B[e]={callback:t,key:null,description:null}},removeKeyBinding:function(e){delete B[e]},registerPlugin:function(e,t){void 0===k[e]?(k[e]=t,v&&"function"==typeof t.init&&t.init()):console.warn('reveal.js: "'+e+'" plugin has already been registered')},hasPlugin:function(e){return!!k[e]},getPlugin:function(e){return k[e]},triggerKey:function(e){Pt({keyCode:e})},registerKeyboardShortcut:function(e,t){z[e]=t}}}),define("@ember/ordered-set/index",["exports"],function(e){"use strict"
...
var d=function(e){function t(e){return n(this,t),r(this,u(t).call(this,e,"Request was rejected because user is not permitted to perform this operation.",403))}return i(t,l),t}()
e.ForbiddenError=d
...
return d(e)&&0!==n.length&&(e=p(e)),n.push(e),n.join("/")},handleResponse:function(e,t,n,r){return this.isSuccess(e,t,n)?n:(n=this.normalizeErrorResponse(e,t,n),this._createCorrectError(e,t,n,r))},_createCorrectError:function(e,n,r,i){var o
...
e.default=r})
define("ember-data/-private",["exports","ember-inflector","@ember/ordered-set","ember-data/version","require"],function(e,t,n,r,i){"use strict"
...
return(t=Ember.get(this,"content"))[e].apply(t,arguments)}}var d=a.extend({reload:function(e){return this.set("promise",this.get("content").reload(e)),this},createRecord:h("createRecord"),on:h("on"),one:h("one"),trigger:h("trigger"),off:h("off"),has:h("has")}),f=Ember.ArrayProxy.extend(Ember.Evented,{_registerHandlers:function(e,t,n){this.on("becameInvalid",e,t),this.on("becameValid",e,n)},errorsByAttributeName:Ember.computed(function(){return new Map}),errorsFor:function(e){var t=Ember.get(this,"errorsByAttributeName")
...
return e}function T(e){return x(function e(t){var n,r={}
for(var i in t)n=t[i],r[i]=n&&"object"==typeof n?e(n):n
return r}(k),e)}var C=T({dirtyType:"created",isNew:!0})
...
return n}function z(e){return!(Ember.get(e,"isDestroyed")||Ember.get(e,"isDestroying"))}function B(e,t,n){return F(Ember.RSVP.resolve(e,n).then(function(t){return e}),function(){return z(t)})}function q(e,t){for(var n=e.length,r=t.length,i=Math.min(n,r),o=null,a=0;a<i;a++)if(e[a]!==t[a]){o=a
...
if(void 0!==t)return t.getRecord()},flushCanonical:function(e,t){if(void 0===t&&(t=!0),z(this)){var n=q(this.currentState,e)
...
return s||(s=d.create({promise:this.fetchAsyncHasMany(r,n,a,t),content:a}),this._relationshipPromisesCache[e]=s),s}return a.set("isLoaded",!0),a},i._updateLoadingPromiseForHasMany=function(e,t,n){var r=this._relationshipPromisesCache[e]
return r?(n&&r.set("content",n),r.set("promise",t)):this._relationshipPromisesCache[e]=d.create({promise:t,content:n}),this._relationshipPromisesCache[e]},i.reloadHasMany=function(e,t){var n=this._relationshipPromisesCache[e]
...
return void 0===r&&(r=e.serializerFor(n)),null==r&&(r={extract:function(e,t,n){return n}}),r}function ke(e){return null==e||""===e?null:"string"==typeof e?e:"symbol"==typeof e?e.toString():""+e}function xe(e,t,n,r,i,o){var a=Ember.A(i.map(function(e){return e.createSnapshot(o.get(e))})),s=t.modelFor(n),u=e.findMany(t,s,r,a),l="DS: Handle Adapter#findMany of '"+n+"'"
if(void 0===u)throw new Error("adapter.findMany returned undefined, this was very likely a mistake")
return(u=B(u,t,l)).then(function(r){var i=Ae(Se(t,e,n),t,s,r,null,"findMany")
return t._push(i)},null,"DS: Extract payload of "+n)}function Te(e,t,n,r){var i,o,a,s=(o=t.data,a=function(t,i){var o=t.id,a=t.type
...
return e._query(this.modelName,t,this)},_setInternalModels:function(e,t){this.get("content").setObjects(e),this.setProperties({isLoaded:!0,isUpdating:!1,meta:Oe(t.meta),links:Oe(t.links)}),this.manager._associateWithRecordArray(e,this),Ember.run.once(this,"trigger","didLoad")}}),Le=Ember.run.backburner,je=function(){function e(e){this.store=e.store,this.isDestroying=!1,this.isDestroyed=!1,this._liveRecordArrays=Object.create(null),this._pending=Object.create(null),this._adapterPopulatedRecordArrays=[]}var t=e.prototype
...
Object.keys(this._liveRecordArrays).forEach(function(t){return e._liveRecordArrays[t].destroy()}),this._adapterPopulatedRecordArrays.forEach(Ie),this.isDestroyed=!0},t.destroy=function(){this.isDestroying=!0,Le.schedule("actions",this,this.willDestroy)},e}()
function Ie(e){e.destroy()}function Fe(e,t){for(var n=0,r=e.length;n<r;n++){e[n]._recordArrays.add(t)}}function ze(e,t){for(var n=0;n<t.length;n++){var r=t[n]
...
this.recordData=r,this.members=new j,this.canonicalMembers=new j,this.store=e,this.key=n.key||null,this.inverseKey=t,this.isAsync=void 0===o||o,this.isPolymorphic=void 0!==a&&a,this.relationshipMeta=n,this.inverseKeyForImplicit=this._tempModelName+this.key,this.meta=null,this.__inverseMeta=void 0,this.shouldForceReload=!1,this.relationshipIsStale=!1,this.hasDematerializedInverse=!1,this.hasAnyRelationshipData=!1,this.relationshipIsEmpty=!0}var t,n,r,i=e.prototype
...
return!e&&this.willSync&&(e=this.canonicalState.reduce(function(e,t){return e||!t.isEmpty()},!1)),!e}}])&&qe(i.prototype,o),a&&qe(i,a),r}(Be)
...
return"hasMany"===e.kind?new Ue(t,i,e,n,o):new Ve(t,i,e,n,o)}(i,r.store,r,e))}return n},e}()
function Ye(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}var Ke=1,Ge=function(){function e(e,t,n,r,i){this.store=void 0,this.modelName=void 0,this.__relationships=void 0,this.__implicitRelationships=void 0,this.clientId=void 0,this.id=void 0,this.storeWrapper=void 0,this.isDestroyed=void 0,this._isNew=void 0,this._bfsId=void 0,this.__attributes=void 0,this.__inFlightAttributes=void 0,this.__data=void 0,this._scheduledDestroy=void 0,this.store=i,this.modelName=e,this.__relationships=null,this.__implicitRelationships=null,this.clientId=n,this.id=t,this.storeWrapper=r,this.isDestroyed=!1,this._isNew=!1,this._bfsId=0,this.reset()}var t,n,r,i=e.prototype
...
var t=null
e&&(e.relationships&&this._setupRelationships(e),e.id&&(this.storeWrapper.setRecordId(this.modelName,e.id,this.clientId),this.id=ke(e.id)),t=e.attributes||null)
...
e=e.concat(r,i)}),e},i._allRelatedRecordDatas=function(){var t=[],n=[],r=Ke++
...
function Ze(e,t){return u(e.then(function(e){return e.getRecord()}),t)}var et=Ember.Service.extend({init:function(){this._super.apply(this,arguments),this._backburner=Qe,this.recordArrayManager=new je({store:this}),this._identityMap=new we,this._newlyCreated=new we,this._pendingSave=[],this._modelFactoryCache=Object.create(null),this._relationshipsDefCache=Object.create(null),this._attributesDefCache=Object.create(null),this._pendingSave=[],this._updatedRelationships=[],this._pushedInternalModels=[],this._updatedInternalModels=[],this._pendingFetch=new Map,this._adapterCache=Object.create(null),this._serializerCache=Object.create(null),this.storeWrapper=new Re(this)},adapter:"-json-api",defaultAdapter:Ember.computed("adapter",function(){var e=Ember.get(this,"adapter")
...
for(var g=r.groupRecordsForFindMany(this,m),y=0,b=g.length;y<b;y++){for(var _=g[y],E=g[y].length,w=new Array(E),R=new Array(E),A=0;A<E;A++){var S=_[A]._internalModel
R[A]=S,w[A]=S.id}if(E>1)(function(e){xe(r,n,t,w,e,u).then(function(t){f(t,e)}).catch(function(t){p(e,t)})})(R)
else if(1===w.length){d(s[R[0].id])}}}else for(var k=0;k<o;k++)d(e[k])},getReference:function(e,t){var n=p(e)
...
var n=e.modelName
this.adapterFor(n)
return this._scheduleFetch(e,t)},hasRecordForId:function(e,t){var n=p(e),r=ke(t),i=this._internalModelsFor(n).get(r)
...
return(u=F(u=B(u,t,l),I(z,n))).then(function(r){var o=Ae(Se(t,e,i.type),t,s,r,null,"findHasMany")
Te(t,o,n,i)
var a=t._push(o)
...
return(u=F(u=B(u,t,l),I(z,n))).then(function(r){var o=Ae(Se(t,e,i.type),t,s,r,null,"findBelongsTo")
return o.data?(Te(t,o,n,i),t._push(o)):null},null,"DS: Extract payload of "+n.modelName+" : "+i.type)}(this.adapterFor(e.modelName),this,e,t,n,r)},_fetchBelongsToLinkFromResource:function(e,t,n,r){return e&&e.links&&e.links.related?this.findBelongsTo(t,e.links.related,n,r).then(function(e){var r=e&&w(e).getResourceIdentifier()
...
return(s=F(s=B(s,t,l),I(z,i))).then(function(e){return t._backburner.join(function(){var o,s,l
e&&((o=Ae(u,t,a,e,r.id,n)).included&&(l=o.included),s=o.data),t.didSaveRecord(i,{data:s}),l&&t._push({data:null,included:l})}),i},function(e){if(e instanceof de){var n=u.extractErrors(t,a,e,r.id)
...
var ht=ct
e.Model=oe,e.Errors=f,e.Store=et,e.DS=it,e.belongsTo=function(e,t){var n,r
...
n?n=n[2]:-1!==e.source.pointer.search(se)&&(n=ue),n&&(t[n]=t[n]||[],t[n].push(e.detail||e.title))}}),t},e.recordDataFor=w,e.relationshipsFor=R,e.relationshipStateFor=A,e.normalizeModelName=p,e.modelHasAttributeOrRelationshipNamedType=function(e){return Ember.get(e,"attributes").has("type")||Ember.get(e,"relationshipsByName").has("type")},e.coerceId=ke,e.parseResponseHeaders=function(e){var t=Object.create(null)
if(!e)return t
...
e.RecordData=Ge,e.PromiseArray=a,e.PromiseObject=s,e.PromiseManyArray=d,e.RecordArray=De,e.AdapterPopulatedRecordArray=Ne,e.ManyArray=U,e.RecordArrayManager=je,e.Relationship=Be,e.DebugAdapter=st,e.diffArray=q,e.SnapshotRecordArray=Pe,e.determineBodyPromise=function(e,t){return e.text().then(function(n){var r=n
...
return e}var d=t.default.extend(n.BuildURLMixin,{defaultSerializer:"-rest",fastboot:Ember.computed(function(){return Ember.getOwner(this).lookup("service:fastboot")}),useFetch:Ember.computed(function(){var e=Ember.getOwner(this).resolveRegistration("config:environment")
...
default:if(e>=500)return new n.ServerError(o,a)}return new n.AdapterError(o,a)},isSuccess:function(e,t,n){return e>=200&&e<300||304===e},isInvalid:function(e,t,n){return 422===e},ajax:function(e,t,i){var o=this,c=Ember.get(this,"useFetch"),h={url:e,method:t},d=o.ajaxOptions(e,t,i)
return c?this._fetchRequest(d).then(function(e){return Ember.RSVP.hash({response:e,payload:(0,n.determineBodyPromise)(e,h)})},function(e){throw e}).then(function(e){var t=e.response,n=e.payload
if(t.ok)return function(e,t,n,r){var i=u(n)
return a(e,t,r,i)}(o,n,t,h)
throw function(e,t,n,r,i){var o=u(n)
return o.errorThrown=r,s(e,t,i,o)}(o,n,t,null,h)}):new r(function(e,t){d.success=function(t,n,r){var i=function(e,t,n,r){var i=l(n)
...
if(null!==g)if(!v||Array.isArray(g)){var y,b,_=this._normalizeArray(e,m,g,d),E=_.data,w=_.included
...
else if(E)(b=s.included).push.apply(b,E)}else{var R,A=this._normalizePolymorphicRecord(e,g,d,t,this),S=A.data,k=A.included
s.data=S,k&&(R=s.included).push.apply(R,k)}}}return s},isPrimaryType:function(e,t,n){return e.modelFor(t)===n},pushPayload:function(e,t){var n={data:[],included:[]}
...
return e._dict=null,delete e._dict,e}}),define("open-slide-reveal-template/components/reveal-slides",["exports","open-slide-reveal-template/templates/components/reveal-slides"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=Ember.Component.extend({tagName:"",layout:t.default})
e.default=n}),define("open-slide-reveal-template/templates/application",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.HTMLBars.template({id:"eGcaQUH2",block:'{"symbols":[],"statements":[[5,"reveal-slides",[],[["@slides"],[[23,"model"]]]],[0,"\\n\\n"],[7,"script"],[11,"src","/plugin/notes/notes.js"],[11,"type","text/javascript"],[9],[10],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"open-slide-reveal-template/templates/application.hbs"}})
e.default=t}),define("open-slide-reveal-template/templates/components/reveal-slides",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.HTMLBars.template({id:"EoxYVOaO",block:'{"symbols":["slide","@slides"],"statements":[[7,"div"],[11,"class","reveal"],[9],[0,"\\n\\t"],[7,"div"],[11,"class","slides"],[9],[0,"\\n"],[4,"each",[[24,2,[]]],null,{"statements":[[0,"      "],[7,"section"],[11,"data-markdown",""],[9],[0,"\\n        "],[7,"textarea"],[11,"data-template",""],[9],[0,""],[1,[24,1,["content"]],false],[0,"\\n"],[4,"if",[[24,1,["notes"]]],null,{"statements":[[0,"Note:\\n"],[1,[24,1,["notes"]],false],[0,""]],"parameters":[]},null],[0,"        "],[10],[0,"      "],[10],[0,"\\n"]],"parameters":[1]},null],[0,"\\t"],[10],[0,"\\n"],[10],[0,"\\n\\n\\n"],[7,"script"],[9],[0,"\\n  if(typeof FastBoot === \'undefined\') {\\n    Reveal.initialize({\\n      hash: true,\\n      dependencies: [\\n\\t\\t\\t\\t\\t{ src: \'/plugin/markdown/marked.js\' },\\n\\t\\t\\t\\t\\t{ src: \'/plugin/markdown/markdown.js\' },\\n\\t\\t\\t\\t\\t{ src: \'/plugin/highlight/highlight.js\', async: true, callback: function() { hljs.initHighlightingOnLoad(); } },\\n\\t\\t\\t\\t\\t{ src: \'/plugin/notes/notes.js\', async: true }\\n\\t\\t\\t\\t]\\n    });\\n  }\\n"],[10],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"open-slide-reveal-template/templates/components/reveal-slides.hbs"}})
e.default=t}),define("open-slide/adapters/application",["exports","ember-data"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=t.default.JSONAPIAdapter.extend({urlForFindAll:function(e){var t=this.pathForType(e)
return"/".concat(t,"/all.json")},urlForFindRecord:function(e,t){var n=this.pathForType(t)
return"/".concat(n,"/").concat(e,".json")}})
e.default=n}),define("open-slide/models/slide",["exports","ember-data"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var n=t.default.Model.extend({content:t.default.attr(),html:t.default.attr(),notes:t.default.attr()})
e.default=n}),define("open-slide/routes/application",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.Route.extend({model:function(){return this.store.findAll("slide")}})
e.default=t})
